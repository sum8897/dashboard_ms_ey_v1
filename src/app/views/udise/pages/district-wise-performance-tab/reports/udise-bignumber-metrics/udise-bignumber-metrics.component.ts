...
@Component({
  selector: 'app-udise-bignumber-metrics',
  templateUrl: './udise-bignumber-metrics.component.html',
  styleUrls: ['./udise-bignumber-metrics.component.scss']
})
export class UdiseBignumberMetricsComponent implements OnInit {
  reportName: string = 'udise_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
