...
@Component({
  selector: 'app-nishtha-bignumber-metrics',
  templateUrl: './nishtha-bignumber-metrics.component.html',
  styleUrls: ['./nishtha-bignumber-metrics.component.scss']
})
export class NishthaBignumberMetricsComponent implements OnInit {
  reportName: string = 'nishtha_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
