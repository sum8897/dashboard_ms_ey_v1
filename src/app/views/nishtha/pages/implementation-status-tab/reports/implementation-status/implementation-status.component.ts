...
import { ImplementationStatusTabComponent } from '../../implementation-status-tab.component';
            ...
            export class ImplementationStatusComponent implements OnInit {
              ...
              constructor(private csv : ImplementationStatusTabComponent,private readonly _dataService: DataService, private readonly _wrapperService: WrapperService, private _rbacService: RbacService) {
                ...
                Object.keys(queries).forEach(async (key: any) => {
                  ...
                  if (query && key === 'table') {
                    ...
                    if (this.reportData?.data?.length > 0) {
                      console.log('tthhhh',this.reportData);
