...
export class ImplementationStatusTabComponent implements OnInit, AfterViewInit {
...
constructor(private _wrapperService: WrapperService, private _rbacService: RbacService) {
    ...
    if (this.hasCommonFilters) {
        ...
        this.implementationStatus?.getReportData({ filterValues: this.filters.map((filter) => { return { columnName: filter.valueProp, value: filter.value } }) });
        }
    ...
    this.reportsData = [];
    this.implementationStatus?.getReportData({ filterValues: filters.map((filter) => { return { columnName: filter.valueProp, value: filter.value } }) });
        }
