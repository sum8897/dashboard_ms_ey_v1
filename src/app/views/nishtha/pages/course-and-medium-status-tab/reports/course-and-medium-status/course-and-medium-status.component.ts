...
@Component({
  ...
  templateUrl: './course-and-medium-status.component.html',
  styleUrls: ['./course-and-medium-status.component.scss']
})
export class CourseAndMediumStatusComponent implements OnInit {
  reportName: string = 'course_and_medium_status';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Course and Medium Status"
  };
  title: string = 'Course and Medium Status'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
  ...
  constructor(private spinner: NgxSpinnerService,private readonly _dataService: DataService, private csv: CourseAndMediumStatusTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService) {
