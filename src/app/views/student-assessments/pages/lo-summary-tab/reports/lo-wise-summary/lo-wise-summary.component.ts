...
@Component({
  selector: 'app-lo-wise-summary',
  templateUrl: './lo-wise-summary.component.html',
  styleUrls: ['./lo-wise-summary.component.scss']
})
export class LoWiseSummaryComponent implements OnInit {

  reportName: string = 'lo_wise_avg_student_assessment_score_table';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Learning Outcomes wise Summary"
  };
  title: string = 'Learning Outcomes wise Summary'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
