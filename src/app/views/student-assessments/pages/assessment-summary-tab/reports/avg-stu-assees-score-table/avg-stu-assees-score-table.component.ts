...
@Component({
  selector: 'app-avg-stu-assees-score-table',
  templateUrl: './avg-stu-assees-score-table.component.html',
  styleUrls: ['./avg-stu-assees-score-table.component.scss']
})
export class AvgStuAsseesScoreTableComponent implements OnInit {

  reportName: string = 'average_student_assessment_score_table';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: ""
