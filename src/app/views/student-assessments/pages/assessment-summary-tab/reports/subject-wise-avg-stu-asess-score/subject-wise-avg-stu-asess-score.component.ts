...
@Component({
  selector: 'app-subject-wise-avg-stu-asess-score',
  templateUrl: './subject-wise-avg-stu-asess-score.component.html',
  styleUrls: ['./subject-wise-avg-stu-asess-score.component.scss']
})
export class SubjectWiseAvgStuAsessScoreComponent implements OnInit {

  reportName: string = 'subject_wise_avg_student_assessment_barchart';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: ""
