...
@Component({
  selector: 'app-grade-wise-avg-stu-asess-score',
  templateUrl: './grade-wise-avg-stu-asess-score.component.html',
  styleUrls: ['./grade-wise-avg-stu-asess-score.component.scss']
})
export class GradeWiseAvgStuAsessScoreComponent implements OnInit {

  reportName: string = 'grade_wise_avg_student_assessment_score_barchart';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Grade Wise Average Student Assessment Scores"
  };
  title: string = 'Grade Wise Average Student Assessment Scores'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
