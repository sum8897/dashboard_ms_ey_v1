...
@Component({
  selector: 'app-gradewise-table',
  templateUrl: './gradewise-table.component.html',
  styleUrls: ['./gradewise-table.component.scss']
})
export class GradewiseTableComponent implements OnInit, OnDestroy {
