...
import { PerformanceTableComponent } from './reports/performance-table/performance-table.component';
import { GradewiseTableComponent } from './reports/gradewise-table/gradewise-table.component';
import moment from 'moment';
@Component({
  selector: 'app-performance-evaluation-tab',
  templateUrl: './performance-evaluation-tab.component.html',
  styleUrls: ['./performance-evaluation-tab.component.scss']
})
export class PerformanceEvaluationTabComponent implements OnInit, OnDestroy {
...
bigNumberMetrics: any = [];
  ...
  tabLabel:any='Performance Evaluation';
