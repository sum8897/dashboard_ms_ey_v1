...
@Component({
  ...
  styleUrls: ['./student-participation-table.component.scss']
})
export class StudentParticipationTableComponent implements OnInit, OnDestroy {
  reportName: string = 'student_participation_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Student Participation"
  };
  minDate: any;
  maxDate: any;
