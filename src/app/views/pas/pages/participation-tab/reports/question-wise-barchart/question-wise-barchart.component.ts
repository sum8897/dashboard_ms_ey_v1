...
@Component({
  selector: 'app-question-wise-barchart',
  templateUrl: './question-wise-barchart.component.html',
  styleUrls: ['./question-wise-barchart.component.scss']
})
export class QuestionWiseBarchartComponent implements OnInit, OnDestroy {
  ...
  config;
  data;
  fileName: string = "Question Wise Student Participation";
  reportName: string = 'question_wise_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
