...
@Component({
  selector: 'app-school-participation-table',
  templateUrl: './school-participation-table.component.html',
  styleUrls: ['./school-participation-table.component.scss']
})
export class SchoolParticipationTableComponent implements OnInit, OnDestroy {
  reportName: string = 'school_participation_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  bigNumberReportData: any = {
    reportName: "School Participation"
  };
  minDate: any;
  maxDate: any;
  ...
  constructor(
    ...
    private csv: ParticipationTabComponent,
