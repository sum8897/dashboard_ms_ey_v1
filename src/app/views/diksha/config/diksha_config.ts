...
learning_sessions:{"label":"----- to be filled -----","defaultLevel":"----- to be filled -----","filters":[{"name":"","hierarchyLevel":"","actions":{"queries":{"barChart":""},"level":"","nextLevel":""}}],"options":{"barChart":{"metricLabelProp":"","metricValueProp":"","yAxis":{"title":""},"xAxis":{"title":"","label":"","value":""}}}},
learning_sessions_on_potential_users:{"label":"----- to be filled -----","defaultLevel":"----- to be filled -----","filters":[{"name":"","hierarchyLevel":"","actions":{"queries":{"map":""},"level":"","nextLevel":""}}],"options":{"map":{"metricFilterNeeded":false,"indicator":"","indicatorType":"","legend":{"title":""},"tooltipMetrics":[{"valuePrefix":"","value":"","valueSuffix":"\n"}]}}},
}