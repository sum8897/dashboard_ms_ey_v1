...
@Component({
  selector: 'app-content-coverage-map',
  templateUrl: './content-coverage-map.component.html',
  styleUrls: ['./content-coverage-map.component.scss']
})
export class ContentCoverageMapComponent implements OnInit {

  reportName: string = 'content_coverage_map';
  filters: any = [];
  levels: any;
  reportData: any = {
