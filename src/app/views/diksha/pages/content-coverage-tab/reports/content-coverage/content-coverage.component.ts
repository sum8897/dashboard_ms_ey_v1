...
@Component({
  selector: 'app-content-coverage',
  templateUrl: './content-coverage.component.html',
  styleUrls: ['./content-coverage.component.scss']
})
export class ContentCoverageComponent implements OnInit {
  reportName: string = 'content_coverage';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "content_coverage"
  };
