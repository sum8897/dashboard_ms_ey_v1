...
export class SummaryTableComponent  implements OnInit, OnDestroy {
  reportName: string = 'summary_table_library';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: SummaryTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
