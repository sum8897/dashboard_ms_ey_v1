...
@Component({
  selector: 'app-analysis-barchart',
  templateUrl: './analysis-barchart.component.html',
  styleUrls: ['./analysis-barchart.component.scss']
})
export class AnalysisBarchartComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'analysis_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
  ...
  constructor(
    ...
    private csv: DistrictWiseSummaryTabComponent
  ) {
