...
@Component({
  selector: 'app-device-type-wise-bar-chart',
  templateUrl: './device-type-wise-bar-chart.component.html',
  styleUrls: ['./device-type-wise-bar-chart.component.scss']
})
export class DeviceTypeWiseBarChartComponent implements OnInit {

  reportName: string = 'deviceTypeWiseBarChart';
  filters: any = [];
  levels: any;
  reportData: any = {
