...
@Component({
  selector: 'app-time-spent-per-page-bar-chart',
  templateUrl: './time-spent-per-page-bar-chart.component.html',
  styleUrls: ['./time-spent-per-page-bar-chart.component.scss']
})
export class TimeSpentPerPageBarChartComponent implements OnInit {

  reportName: string = 'timeSpentPerPageBarChart';
  filters: any = [];
  levels: any;
  reportData: any = {
