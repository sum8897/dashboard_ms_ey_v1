...
@Component({
  selector: 'app-browser-type-wise-bar-chart',
  templateUrl: './browser-type-wise-bar-chart.component.html',
  styleUrls: ['./browser-type-wise-bar-chart.component.scss']
})
export class BrowserTypeWiseBarChartComponent implements OnInit {
  reportName: string = 'browserTypeWiseBarChart';
  filters: any = [];
  levels: any;
  reportData: any = {
