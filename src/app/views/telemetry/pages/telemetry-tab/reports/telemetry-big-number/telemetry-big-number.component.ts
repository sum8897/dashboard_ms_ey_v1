...
@Component({
  selector: 'app-telemetry-big-number',
  templateUrl: './telemetry-big-number.component.html',
  styleUrls: ['./telemetry-big-number.component.scss']
})
export class TelemetryBigNumberComponent implements OnInit {

  reportName: string = 'telemetry_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
