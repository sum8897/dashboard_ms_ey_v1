...
export class PerformanceTabComponent implements OnInit, AfterViewInit {
  ...
  tabLabel:any='Student Availability';
    // tabName:any ='Student Performance';

  @ViewChild('studentavailability') studentavailability:PerformanceComponent
