...
@Component({
  selector: 'app-ques-wise-performance',
  templateUrl: './ques-wise-performance.component.html',
  styleUrls: ['./ques-wise-performance.component.scss']
})

// "Question Wise Performance"

export class QuesWisePerformanceComponent implements OnInit {
  reportName: string = 'ques_wise_performance';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  bigNumberReportData: any = {
    reportName: "Question Wise Performance"
  };
  minDate: any;
  maxDate: any;
