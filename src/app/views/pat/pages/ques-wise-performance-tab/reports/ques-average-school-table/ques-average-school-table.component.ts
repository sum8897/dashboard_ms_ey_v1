...
@Component({
  selector: 'app-ques-average-school-table',
  templateUrl: './ques-average-school-table.component.html',
  styleUrls: ['./ques-average-school-table.component.scss']
})
export class QuesAverageSchoolTableComponent implements OnInit, OnDestroy {
  reportName: string = 'ques_average_school';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: QuesWisePerformanceTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
