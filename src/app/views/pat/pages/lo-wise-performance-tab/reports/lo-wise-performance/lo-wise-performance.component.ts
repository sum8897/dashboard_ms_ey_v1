...
@Component({
  selector: 'app-lo-wise-performance',
  templateUrl: './lo-wise-performance.component.html',
  styleUrls: ['./lo-wise-performance.component.scss']
})
export class LoWisePerformanceComponent implements OnInit, OnDestroy {
  reportName: string = 'lo_wise_performance';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  bigNumberReportData: any = {
    reportName: "LO Wise Performance"
  };
  minDate: any;
  maxDate: any;
  ...
  constructor(
    ...
    private csv: LoWisePerformanceTabComponent,
