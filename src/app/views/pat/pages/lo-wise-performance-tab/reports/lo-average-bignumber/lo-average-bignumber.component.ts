...
@Component({
  selector: 'app-lo-average-bignumber',
  templateUrl: './lo-average-bignumber.component.html',
  styleUrls: ['./lo-average-bignumber.component.scss']
})
export class LoAverageBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'lo_average_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
