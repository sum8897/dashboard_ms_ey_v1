...
@Component({
  selector: 'app-lo-average-school-table',
  templateUrl: './lo-average-school-table.component.html',
  styleUrls: ['./lo-average-school-table.component.scss']
})
export class LoAverageSchoolTableComponent implements OnInit, OnDestroy {
  reportName: string = 'lo_average_school';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: LoWisePerformanceTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
