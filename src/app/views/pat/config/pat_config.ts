        ...
        "filters": [
            {
                ...
                "hierarchyLevel": "1",
                "timeSeriesQueries": {
                    "table": "SELECT a.district_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, district_wise_table.district_name, ROUND(a.avg_ques) AS perc_QUES FROM (SELECT qt.district_id, qt.class_id, qt.subject_id, qt.question_id, qt.date AS EX_date, qt.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_MQM2AhwUAw8XaQpDXWJw AS qt JOIN datasets.pat_total_count_Daily_district AS total_ques_table ON qt.date = total_ques_table.date AND qt.district_id = total_ques_table.district_id) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.district AS district_wise_table ON district_wise_table.district_id = a.district_id WHERE a.EX_date BETWEEN startDate AND endDate GROUP BY a.district_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, a.avg_ques, district_wise_table.district_name ORDER BY perc_QUES ASC;",
                },
                "actions": {
                    "queries": {
                        "table": "SELECT a.district_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, district_wise_table.district_name, ROUND(a.avg_ques) AS perc_QUES FROM (SELECT qt.district_id, qt.class_id, qt.subject_id, qt.question_id, qt.date AS EX_date, qt.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_MQM2AhwUAw8XaQpDXWJw AS qt JOIN datasets.pat_total_count_Daily_district AS total_ques_table ON qt.date = total_ques_table.date AND qt.district_id = total_ques_table.district_id) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.district AS district_wise_table ON district_wise_table.district_id = a.district_id WHERE a.EX_date BETWEEN startDate AND endDate GROUP BY a.district_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, a.avg_ques, district_wise_table.district_name ORDER BY perc_QUES ASC;",
            ...
            },
            {
                ...
                "hierarchyLevel": "2",
                "timeSeriesQueries": {
                    "table": "SELECT a.block_id, block_wise_table.block_name, cc.class_name, cc.class_id, a.ex_date, q.question, q.question_id, ROUND(a.avg_ques) AS perc_ques FROM (SELECT lt.block_id, lt.class_id, lt.subject_id, lt.question_id, lt.date AS ex_date, lt.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_OwU0BRoAWANGRn9__UWli AS lt JOIN datasets.pat_total_count_Daily_block AS tlt ON lt.date = tlt.date AND lt.block_id = tlt.block_id JOIN dimensions.classes AS cc ON cc.class_id = lt.class_id JOIN dimensions.subjects AS s ON s.subject_id = lt.subject_id JOIN dimensions.questions AS q ON q.question_id = lt.question_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = lt.block_id WHERE lt.date BETWEEN startDate AND endDate) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = a.block_id WHERE block_wise_table.district_id = {district_id} GROUP BY a.block_id, cc.class_name, cc.class_id, q.question, q.question_id, block_wise_table.block_name, a.avg_ques, a.ex_date ORDER BY perc_ques ASC;",
                },
                "actions": {
                    "queries": {
                        "table": "SELECT a.block_id, block_wise_table.block_name, cc.class_name, cc.class_id, a.ex_date, q.question, q.question_id, ROUND(a.avg_ques) AS perc_ques FROM (SELECT lt.block_id, lt.class_id, lt.subject_id, lt.question_id, lt.date AS ex_date, lt.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_OwU0BRoAWANGRn9__UWli AS lt JOIN datasets.pat_total_count_Daily_block AS tlt ON lt.date = tlt.date AND lt.block_id = tlt.block_id JOIN dimensions.classes AS cc ON cc.class_id = lt.class_id JOIN dimensions.subjects AS s ON s.subject_id = lt.subject_id JOIN dimensions.questions AS q ON q.question_id = lt.question_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = lt.block_id WHERE lt.date BETWEEN startDate AND endDate) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = a.block_id WHERE block_wise_table.district_id = {district_id} GROUP BY a.block_id, cc.class_name, cc.class_id, q.question, q.question_id, block_wise_table.block_name, a.avg_ques, a.ex_date ORDER BY perc_ques ASC;",
            ...
            },
            {
                ...
                "hierarchyLevel": "3",
                "timeSeriesQueries": {
                    "table": "SELECT a.cluster_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, cluster_wise_table.cluster_name, ROUND(a.avg_ques) AS perc_QUES FROM (SELECT ques_table.cluster_id, ques_table.subject_id, ques_table.class_id, ques_table.question_id, ques_table.date AS EX_date, ques_table.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_OQQxBhwMBwVCPFtoUntq AS ques_table JOIN datasets.pat_total_count_Daily_cluster AS total_ques_table ON ques_table.date = total_ques_table.date AND ques_table.cluster_id = total_ques_table.cluster_id) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.cluster AS cluster_wise_table ON cluster_wise_table.cluster_id = a.cluster_id WHERE block_id = {block_id} AND a.EX_date BETWEEN startDate AND endDate GROUP BY a.cluster_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, a.avg_ques, cluster_wise_table.cluster_name ORDER BY perc_QUES ASC;",
                },
                "actions": {
                    "queries": {
                        "table": "SELECT a.cluster_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, cluster_wise_table.cluster_name, ROUND(a.avg_ques) AS perc_QUES FROM (SELECT ques_table.cluster_id, ques_table.subject_id, ques_table.class_id, ques_table.question_id, ques_table.date AS EX_date, ques_table.avg AS avg_ques FROM datasets.pat_question_wise_student_correct_marks_OQQxBhwMBwVCPFtoUntq AS ques_table JOIN datasets.pat_total_count_Daily_cluster AS total_ques_table ON ques_table.date = total_ques_table.date AND ques_table.cluster_id = total_ques_table.cluster_id) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.questions AS q ON q.question_id = a.question_id JOIN dimensions.cluster AS cluster_wise_table ON cluster_wise_table.cluster_id = a.cluster_id WHERE block_id = {block_id} AND a.EX_date BETWEEN startDate AND endDate GROUP BY a.cluster_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, a.avg_ques, cluster_wise_table.cluster_name ORDER BY perc_QUES ASC;",
            ...
            },
            {
                ...
                "hierarchyLevel": "4",
                "timeSeriesQueries": {
                    "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id INNER JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.cluster_id = {cluster_id} AND avg_ques.date BETWEEN startDate AND endDate GROUP BY school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, avg_ques.avg, school.school_name;"
                },
                "actions": {
                    "queries": {
                        "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id INNER JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.cluster_id = {cluster_id} AND avg_ques.date BETWEEN startDate AND endDate GROUP BY school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, avg_ques.avg, school.school_name;",
        ...
        "filters": [
            {
                ...
                "hierarchyLevel": "1",
                "timeSeriesQueries": {
                    "table": "SELECT QUES_AVG.date AS EX_date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND(QUES_AVG.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS QUES_AVG JOIN dimensions.classes AS cc ON cc.class_id = QUES_AVG.class_id JOIN dimensions.subjects AS s ON s.subject_id = QUES_AVG.subject_id JOIN dimensions.questions AS q ON q.question_id = QUES_AVG.question_id INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON QUES_AVG.school_id = total_ques.school_id AND QUES_AVG.date = total_ques.date INNER JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE QUES_AVG.date BETWEEN startDate AND endDate GROUP BY QUES_AVG.date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, QUES_AVG.avg, block_name, cluster_name;"
                },
                "actions": {
                    "queries": {
                        "table": "SELECT QUES_AVG.date AS EX_date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND(QUES_AVG.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS QUES_AVG JOIN dimensions.classes AS cc ON cc.class_id = QUES_AVG.class_id JOIN dimensions.subjects AS s ON s.subject_id = QUES_AVG.subject_id JOIN dimensions.questions AS q ON q.question_id = QUES_AVG.question_id INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON QUES_AVG.school_id = total_ques.school_id AND QUES_AVG.date = total_ques.date INNER JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE QUES_AVG.date BETWEEN startDate AND endDate GROUP BY QUES_AVG.date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, QUES_AVG.avg, block_name, cluster_name;",
            ...
            },
            {
                ...
                "hierarchyLevel": "2",
                "timeSeriesQueries": {
                    "table": "SELECT avg_ques.date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND (avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.district_id = {district_id} AND avg_ques.date BETWEEN startDate AND endDate GROUP BY avg_ques.date, avg_ques.avg, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;"
                },
                "actions": {
                    "queries": {
                        "table": "SELECT avg_ques.date, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND (avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.district_id = {district_id} AND avg_ques.date BETWEEN startDate AND endDate GROUP BY avg_ques.date, avg_ques.avg, school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;",
            ...
            },
            {
                ...
                "hierarchyLevel": "3",
                "timeSeriesQueries": {
                    "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.block_id = {block_id} GROUP BY school.school_id,avg_ques.avg, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;"
                },
                "actions": {
                    "queries": {
                        "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name, ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.block_id = {block_id} GROUP BY school.school_id,avg_ques.avg, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;",
            ...
            },
            {
                ...
                "hierarchyLevel": "4",
                "timeSeriesQueries": {
                    "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name,  ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.cluster_id = {cluster_id} GROUP BY school.school_id,avg_ques.avg, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;"
                },
                "actions": {
                    "queries": {
                        "table": "SELECT school.school_id, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name,  ROUND(avg_ques.avg) AS perc_QUES FROM datasets.pat_question_wise_student_correct_marks_ORY8HB4fFVYXbXBnS2Fi AS avg_ques INNER JOIN datasets.pat_total_count_Daily_school AS total_ques ON avg_ques.school_id = total_ques.school_id AND avg_ques.date = total_ques.date INNER JOIN dimensions.classes AS cc ON cc.class_id = avg_ques.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_ques.subject_id JOIN dimensions.questions AS q ON q.question_id = avg_ques.question_id JOIN dimensions.school ON school.school_id = total_ques.school_id WHERE school.cluster_id = {cluster_id} GROUP BY school.school_id,avg_ques.avg, s.subject_name, s.subject_id, cc.class_name, cc.class_id, q.question, q.question_id, school.school_name, district_name, block_name, cluster_name;",
    ...
    lo_wise_performance: {
        ...
        "filters": [
            ...
            },
            {
                ...
                "hierarchyLevel": "2",
                "timeSeriesQueries": {
                    "table": "SELECT a.block_id, block_wise_table.block_name, cc.class_name, cc.class_id, ing.indicator, a.ex_date, ing.indicator_id, ROUND(a.avg_lo) AS perc_LO FROM (SELECT lt.block_id, lt.class_id, lt.subject_id, lt.indicator_id, lt.date AS ex_date, lt.avg AS avg_lo, tlt.sum AS total_lo FROM datasets.pat_lo_wise_HBgxJgYDOh5ZDEsoT3Nh AS lt JOIN datasets.pat_total_lo_Daily_block AS tlt ON lt.date = tlt.date AND lt.block_id = tlt.block_id JOIN dimensions.classes AS cc ON cc.class_id = lt.class_id JOIN dimensions.subjects AS s ON s.subject_id = lt.subject_id  JOIN dimensions.indicators AS ing ON ing.indicator_id = lt.indicator_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = lt.block_id WHERE lt.date BETWEEN startDate AND endDate) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = a.indicator_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = a.block_id WHERE block_wise_table.district_id = {district_id} GROUP BY a.block_id, cc.class_name, cc.class_id, ing.indicator,a.avg_lo,ing.indicator_id, block_wise_table.block_name, a.ex_date ORDER BY perc_LO ASC;",
                },
                "actions": {
                    "queries": {
                        "table": "SELECT a.block_id, block_wise_table.block_name, cc.class_name, cc.class_id, ing.indicator, a.ex_date, ing.indicator_id, ROUND(a.avg_lo) AS perc_LO FROM (SELECT lt.block_id, lt.class_id, lt.subject_id, lt.indicator_id, lt.date AS ex_date, lt.avg AS avg_lo, tlt.sum AS total_lo FROM datasets.pat_lo_wise_HBgxJgYDOh5ZDEsoT3Nh AS lt JOIN datasets.pat_total_lo_Daily_block AS tlt ON lt.date = tlt.date AND lt.block_id = tlt.block_id JOIN dimensions.classes AS cc ON cc.class_id = lt.class_id JOIN dimensions.subjects AS s ON s.subject_id = lt.subject_id  JOIN dimensions.indicators AS ing ON ing.indicator_id = lt.indicator_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = lt.block_id WHERE lt.date BETWEEN startDate AND endDate) AS a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = a.indicator_id JOIN dimensions.block AS block_wise_table ON block_wise_table.block_id = a.block_id WHERE block_wise_table.district_id = {district_id} GROUP BY a.block_id, cc.class_name, cc.class_id, ing.indicator,a.avg_lo,ing.indicator_id, block_wise_table.block_name, a.ex_date ORDER BY perc_LO ASC; ",
            ...
            },
            {
                ...
                "hierarchyLevel": "3",
                "timeSeriesQueries": {
                    "table": "select a.cluster_id,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id, cluster_name, round(a.avg_lo) as perc_LO from( select lo_table.cluster_id,lo_table.subject_id,lo_table.class_id, lo_table.indicator_id,lo_table.date as EX_date,lo_table.avg as avg_lo,total_lo_table.sum as total_lo from datasets.pat_lo_wise_DhArPBoBKgAKA1UgahZi AS lo_table join datasets.pat_total_lo_Daily_cluster as total_lo_table on lo_table.date = total_lo_table.date and lo_table.cluster_id = total_lo_table.cluster_id) as a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = a.indicator_id join dimensions.cluster as cluster_wise_table on cluster_wise_table.cluster_id = a.cluster_id where block_id = {block_id} and a.EX_date between startDate and endDate group by a.cluster_id,a.avg_lo,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id, cluster_name order by perc_LO asc",
                },
                "actions": {
                    "queries": {
                        "table": "select a.cluster_id,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id, cluster_name, round(a.avg_lo) as perc_LO from( select lo_table.cluster_id,lo_table.subject_id,lo_table.class_id, lo_table.indicator_id,lo_table.date as EX_date,lo_table.avg as avg_lo,total_lo_table.sum as total_lo from datasets.pat_lo_wise_DhArPBoBKgAKA1UgahZi AS lo_table join datasets.pat_total_lo_Daily_cluster as total_lo_table on lo_table.date = total_lo_table.date and lo_table.cluster_id = total_lo_table.cluster_id) as a JOIN dimensions.classes AS cc ON cc.class_id = a.class_id JOIN dimensions.subjects AS s ON s.subject_id = a.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = a.indicator_id join dimensions.cluster as cluster_wise_table on cluster_wise_table.cluster_id = a.cluster_id where block_id = {block_id} and a.EX_date between startDate and endDate group by a.cluster_id,a.avg_lo,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id, cluster_name order by perc_LO asc",
            ...
            },
            {
                ...
                "hierarchyLevel": "4",
                "timeSeriesQueries": {
                    "table": "select  school.school_id,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id,  school.school_name, round(avg_lo.avg) as perc_LO from datasets.pat_lo_wise_FBgrNhQBMx4HQxpxM2p7 as avg_lo  inner join  datasets.pat_total_lo_Daily_school as total_lo on avg_lo.school_id = total_lo.school_id and avg_lo.date = total_lo.date JOIN dimensions.classes AS cc ON cc.class_id = avg_lo.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_lo.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = avg_lo.indicator_id inner join dimensions.school on school.school_id = total_lo.school_id where  school.cluster_id = {cluster_id} and avg_lo.date between startDate and endDate group by  school.school_id,avg_lo.avg,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id,   school_name"
                },
                "actions": {
                    "queries": {
                        "table": "select  school.school_id,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id,  school.school_name, round(avg_lo.avg) as perc_LO from datasets.pat_lo_wise_FBgrNhQBMx4HQxpxM2p7 as avg_lo  inner join  datasets.pat_total_lo_Daily_school as total_lo on avg_lo.school_id = total_lo.school_id and avg_lo.date = total_lo.date JOIN dimensions.classes AS cc ON cc.class_id = avg_lo.class_id JOIN dimensions.subjects AS s ON s.subject_id = avg_lo.subject_id JOIN dimensions.indicators AS ing ON ing.indicator_id = avg_lo.indicator_id inner join dimensions.school on school.school_id = total_lo.school_id where  school.cluster_id = {cluster_id} and avg_lo.date between startDate and endDate group by  school.school_id,avg_lo.avg,s.subject_name,s.subject_id,cc.class_name,cc.class_id,ing.indicator,ing.indicator_id,   school_name",
