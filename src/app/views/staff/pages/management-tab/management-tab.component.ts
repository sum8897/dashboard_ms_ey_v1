...
import { TableDepartmentOneComponent } from "./reports/table-department-one/table-department-one.component";
import { TableDepartmentTwoComponent } from "./reports/table-department-two/table-department-two.component";
...
export class ManagementTabComponent implements OnInit {
  ...
  performing_wise_table_one: TableDepartmentOneComponent;
  @ViewChild("genderTable") genderTable: TableDepartmentTwoComponent;
  ...
  async ngAfterViewInit(): Promise<void> {
    if (this.hasCommonFilters) {
      ...
      this.genderTable?.getReportData(
        {
          filterneed: this.hasCommonFilters,
          filterValues: this.filters.map((filter) => {
            return {
