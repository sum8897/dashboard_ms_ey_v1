...
@Component({
  selector: 'app-table-department-one',
  templateUrl: './table-department-one.component.html',
  styleUrls: ['./table-department-one.component.scss']
})
export class TableDepartmentOneComponent implements OnInit {

   reportName: string = 'management_first_table';
    filters: any = [];
    levels: any;
    tableReportData: any;
    reportsData: any[] = []
    ...
    bigNumberReportData: any = {
      reportName: "Management First Table"
    };
    minDate: any;
    maxDate: any;
