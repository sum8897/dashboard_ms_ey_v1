...
@Component({
  selector: 'app-gender-first-table',
  templateUrl: './gender-first-table.component.html',
  styleUrls: ['./gender-first-table.component.scss']
})
export class GenderFirstTableComponent implements OnInit {

 reportName: string = 'gender_first_table';
        filters: any = [];
        levels: any;
        tableReportData: any;
        reportsData: any[] = []
