...
import { GenderFirstTableComponent } from "./reports/gender-first-table/gender-first-table.component";
...
export class GenderTabComponent implements OnInit {
  ...
  bigNumberReports: any = {};
        ...
        pagereportName = "Gender";
        //
        @ViewChild("performing_wise_table_one")
        performing_wise_table_one: GenderFirstTableComponent;
