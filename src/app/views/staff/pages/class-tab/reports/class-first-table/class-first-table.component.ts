...
@Component({
  selector: 'app-class-first-table',
  templateUrl: './class-first-table.component.html',
  styleUrls: ['./class-first-table.component.scss']
})
export class ClassFirstTableComponent implements OnInit {

 reportName: string = 'class_first_table';
       filters: any = [];
       levels: any;
       tableReportData: any;
       reportsData: any[] = []
