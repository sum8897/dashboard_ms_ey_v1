...
@Component({
  selector: 'app-social-categoty-first-table',
  templateUrl: './social-categoty-first-table.component.html',
  styleUrls: ['./social-categoty-first-table.component.scss']
})
export class SocialCategotyFirstTableComponent implements OnInit {

 reportName: string = 'social_category_first_table';
       filters: any = [];
       levels: any;
       tableReportData: any;
       reportsData: any[] = []
       ...
       bigNumberReportData: any = {
         reportName: "Social Category First Table"
       };
       minDate: any;
       maxDate: any;
