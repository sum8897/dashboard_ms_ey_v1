...
import { InspectingTableOnrComponent } from './reports/inspecting-table-onr/inspecting-table-onr.component';

@Component({
  selector: 'app-inspectig-tab',
  templateUrl: './inspectig-tab.component.html',
  styleUrls: ['./inspectig-tab.component.scss']
})
export class InspectigTabComponent implements OnInit {
