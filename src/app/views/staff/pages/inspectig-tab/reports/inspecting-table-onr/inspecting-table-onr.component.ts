...
@Component({
  selector: 'app-inspecting-table-onr',
  templateUrl: './inspecting-table-onr.component.html',
  styleUrls: ['./inspecting-table-onr.component.scss']
})
export class InspectingTableOnrComponent implements OnInit {

  reportName: string = 'inspecting_first_table';
      filters: any = [];
      levels: any;
      tableReportData: any;
      reportsData: any[] = []
      ...
      constructor(
        ...
        private csv: InspectigTabComponent,
