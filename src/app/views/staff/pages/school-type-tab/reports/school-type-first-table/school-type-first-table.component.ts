...
@Component({
  selector: 'app-school-type-first-table',
  templateUrl: './school-type-first-table.component.html',
  styleUrls: ['./school-type-first-table.component.scss']
})
export class SchoolTypeFirstTableComponent implements OnInit {

  reportName: string = 'school_type_first_table';
        filters: any = [];
        levels: any;
        tableReportData: any;
        reportsData: any[] = []
