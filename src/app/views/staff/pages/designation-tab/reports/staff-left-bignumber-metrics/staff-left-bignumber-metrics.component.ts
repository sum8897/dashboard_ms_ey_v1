...
@Component({
  selector: 'app-staff-left-bignumber-metrics',
  templateUrl: './staff-left-bignumber-metrics.component.html',
  styleUrls: ['./staff-left-bignumber-metrics.component.scss']
})
export class StaffLeftBignumberMetricsComponent implements OnInit {

  reportName: string = 'pgi_metrics';
    filters: any = [];
    levels: any;
    reportData: any = [];
