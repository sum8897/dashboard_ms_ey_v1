...
import { config } from '../../config/staff_config';
import { Table1Component } from './reports/table1/table1.component';
import { Table2Component } from './reports/table2/table2.component';

@Component({
  selector: 'app-designation-tab',
  templateUrl: './designation-tab.component.html',
  styleUrls: ['./designation-tab.component.scss']
})
export class DesignationTabComponent implements OnInit {
 bigNumberReports: any = {};
  ...
  bigNumberMetrics: any = [];
    ...
    tabLabel:any='Designation';
  
    //added for full school report download
    // title = "Download School Report"
    schoolReportsData: any[] = [];
    pagereportName = "Designation"
    //
    @ViewChild('performing_wise_table_one') performing_wise_table_one: Table1Component;
    @ViewChild('genderTable') genderTable:  Table2Component;
