...
import { SchoolTypeTableComponent } from "./reports/school-type-table/school-type-table.component";
import { SchoolTypeGraphComponent } from "./reports/school-type-graph/school-type-graph.component";

@Component({
  selector: "app-school-type-tab",
  templateUrl: "./school-type-tab.component.html",
  styleUrls: ["./school-type-tab.component.scss"],
})
export class SchoolTypeTabComponent implements OnInit {
  ...
  tabLabel: any = "School Type";

  //added for full school report download
  // title = "Download School Report"
  schoolReportsData: any[] = [];
  pagereportName = "School Type";
  //
  @ViewChild("school_type_table_one")
  school_type_table_one: SchoolTypeTableComponent;
  @ViewChild("attendanceGraph") attendanceGraph: SchoolTypeGraphComponent;
  ...
  async ngAfterViewInit(): Promise<void> {
    if (this.hasCommonFilters) {
      ...
      this.school_type_table_one?.getReportData(
        {
