...
@Component({
  selector: "app-school-type-table",
  templateUrl: "./school-type-table.component.html",
  styleUrls: ["./school-type-table.component.scss"],
})
export class SchoolTypeTableComponent implements OnInit {
