...
import { GenderTableComponent } from "./reports/gender-table/gender-table.component";
import { GenderGraphComponent } from "./reports/gender-graph/gender-graph.component";

@Component({
  selector: 'app-gender-tab',
  templateUrl: './gender-tab.component.html',
  styleUrls: ['./gender-tab.component.scss']
})
export class GenderTabComponent implements OnInit {
   ...
   bigNumberReports: any = {};
    ...
    school_type_table_one: GenderTableComponent;
    @ViewChild("attendanceGraph") attendanceGraph: GenderGraphComponent;
