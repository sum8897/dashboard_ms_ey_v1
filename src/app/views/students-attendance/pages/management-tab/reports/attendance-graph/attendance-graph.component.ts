...
@Component({
  ...
  styleUrls: ['./attendance-graph.component.scss']
})
        ...
        Object.keys(queries).forEach(async (key: any) => {
          ...
          if (query && key === 'table'&& filterneed) {
            ...
            // this._dataService.stackBar(reportData,config,"male","Male",'rgba(255, 0, 0, 0.5)',0.42);
                     this._dataService.stackBar(reportData,config,"boys_absent","Boys Absent",'rgba(255, 0, 0, 0.5)',0.42);
          this._dataService.stackBar(reportData,config,"girls_present","Girls Present",'rgba(0, 255, 0, 0.5)',0.4);
          this._dataService.stackBar(reportData,config,"girls_absent","Girls Absent",'rgba(214,215,39, 0.6)',0.4);
    ...
    getBarChartReportData(query, options, filters, defaultLevel): void {
      ...
      this._commonService.getReportDataNew(query).subscribe((res: any) => {
        ...
        // this._dataService.stackBar(this.tableReportData,this.config,"primary_school","Primary",'rgba(0, 0, 255, 0.5)',0.6);
            ...
            this._dataService.stackBar(this.tableReportData,this.config,"boys_absent","Boys Absent",'rgba(255, 0, 0, 0.5)',0.42);
            this._dataService.stackBar(this.tableReportData,this.config,"girls_present","Girls Present",'rgba(0, 255, 0, 0.5)',0.4);
                this._dataService.stackBar(this.tableReportData,this.config,"girls_absent","Girls Absent",'rgba(214,215,39, 0.6)',0.4);
