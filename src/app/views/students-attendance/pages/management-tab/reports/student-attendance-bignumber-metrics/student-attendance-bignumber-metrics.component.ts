...
@Component({
  selector: 'app-student-attendance-bignumber-metrics',
  templateUrl: './student-attendance-bignumber-metrics.component.html',
  styleUrls: ['./student-attendance-bignumber-metrics.component.scss']
})
export class StudentAttendanceBignumberMetricsComponent implements OnInit {
