...
import { StudentMapComponent } from './reports/student-map/student-map.component';
import { config } from 'src/app/views/student-attendance/config/student_attendance_config';
import moment from 'moment';

@Component({
  selector: 'app-student-summary-tab',
  templateUrl: './student-summary-tab.component.html',
  styleUrls: ['./student-summary-tab.component.scss']
})
export class StudentSummaryTabComponent implements OnInit, AfterViewInit {
  ...
  tabLabel:any='Map View of Students Attendance';
    // tabName:any ='Student Performance';

  @ViewChild('studentmap') studentmap:StudentMapComponent
