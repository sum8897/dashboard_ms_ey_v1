...
@Component({
  selector: 'app-student-bignumber',
  templateUrl: './student-bignumber.component.html',
  styleUrls: ['./student-bignumber.component.scss']
})
export class StudentBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'student_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  currentReportName: string = "Average % Students present";
  minDate: any;
  maxDate: any;
  ...
  constructor(private readonly _commonService: CommonService,
    private csv: StudentAverageAttendanceTabComponent, 
