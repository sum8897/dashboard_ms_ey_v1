...
@Component({
  selector: 'app-student-school-table',
  templateUrl: './student-school-table.component.html',
  styleUrls: ['./student-school-table.component.scss']
})
export class StudentSchoolTableComponent implements OnInit, OnDestroy {
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: StudentAverageAttendanceTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
