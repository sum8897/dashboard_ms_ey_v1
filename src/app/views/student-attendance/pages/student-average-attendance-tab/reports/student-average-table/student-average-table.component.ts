...
@Component({
  ...
  styleUrls: ['./student-average-table.component.scss']
})
export class StudentAverageTableComponent implements OnInit, OnDestroy {
  reportName: string = 'student_average_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
