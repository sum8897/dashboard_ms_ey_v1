        ...
        "filters": [
            ...
            },
            {
                ...
                "timeSeriesQueries": {
                    ...
                    "bigNumber": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_atd_cmp_by_school as t where (date between startDate and endDate) and t.school_id={school_id}",
                    "bigNumberComparison": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_atd_cmp_by_school as t where (date between startDate and endDate) and t.school_id={school_id}",
                },
                "actions": {
                    "queries": {
                        ...
                        "bigNumber": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_atd_cmp_by_school as t where t.school_id={school_id}",
                        "bigNumberComparison": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_atd_cmp_by_school as t where (date between startDate and endDate) and t.school_id={school_id}",
                    },
                    "level": "school"
                }
    ...
    sas_average_attendance: {
        ...
        "filters": [
            ...
            },
            {
                ...
                "actions": {
                    "queries": {
                        ...
                        "bigNumber": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_avg_atd_by_school as t where t.school_id={school_id}",
                        "bigNumberComparison": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_avg_atd_by_school as t where (date between startDate and endDate) and t.school_id={school_id}",
                    },  
                    "level": "school"
                }
            },
            {
                ...
                "hierarchyLevel": "6",
                "timeSeriesQueries": {
                    "bigNumber": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_avg_atd_by_grade as t where (date between startDate and endDate) and t.grade={class_id}",
                ...
                "actions": {
                    "queries": {
                        "bigNumber": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_avg_atd_by_grade as t where t.grade={class_id}",
                        "bigNumberComparison": "select round(avg(percentage),2) as percentage from ingestion.sac_stds_avg_atd_by_grade as t where (date between startDate and endDate) and t.grade={class_id}",
                    },
                    "level": "school"
                }
        ...
        "filters": [
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(date) as min_date, max(date) as max_date, district_name as location, round(avg(percentage),2) as percentage, t.gender from ingestion.sac_stds_avg_atd_gender_wise_by_district as t left join ingestion.dimension_district as d on d.district_id = t.district_id left join ingestion.dimension_master as m on t.district_id = m.district_id where m.state_id={state_id} group by t.district_id,district_name, t.gender",
                    },
                    "level": "district"
                }
            },
            ...
            },
            {
                ...
                "hierarchyLevel": "5",
                "timeSeriesQueries": {
                    "barChart": "select t.grade as location, round(avg(percentage),2) as percentage, t.gender from ingestion.sac_stds_avg_atd_gender_wise_by_grade as t where (date between startDate and endDate) and t.school_id={school_id} group by t.grade, t.gender",
                },
                "actions": {
                    "queries": {
                        "barChart": "select min(date) as min_date, max(date) as max_date, t.grade as location, round(avg(percentage),2) as percentage, t.gender from ingestion.sac_stds_avg_atd_gender_wise_by_grade as t where t.school_id={school_id} group by t.grade, t.gender",
                    },
                    "level": "grade"
                }
            },
            {
                ...
                "hierarchyLevel": "6",
                "timeSeriesQueries": {
                    "barChart": "select t.grade as location, round(avg(percentage),2) as percentage, t.gender from ingestion.sac_stds_avg_atd_gender_wise_by_grade as t where (date between startDate and endDate) and t.grade={class_id} group by t.grade, t.gender",
                },
                "actions": {
                    "queries": {
                        "barChart": "select min(date) as min_date, max(date) as max_date, t.grade as location, round(avg(percentage),2) as percentage, t.gender from ingestion.sac_stds_avg_atd_gender_wise_by_grade as t where t.grade={class_id} group by t.grade, t.gender",
                    },
                    "level": "grade"
                }
            }
        ...
        "filters": [
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(date) as min_date, max(date) as max_date, district_name as location, round(avg(percentage),2) as percentage, t.school_category from ingestion.sac_stds_avg_atd_cat_wise_by_district as t left join ingestion.dimension_district as d on d.district_id = t.district_id left join ingestion.dimension_master as m on t.district_id = m.district_id where m.state_id={state_id} group by t.district_id,district_name, t.school_category",
                    },
                    "level": "district"
                }
            },
    ...
    sas_average_attendance_rank: {
        ...
        "filters": [
            ...
            },
            {
                ...
                "hierarchyLevel": "6",
                "timeSeriesQueries": {
                    "table": "select t.grade, dense_rank() over(order by avg(percentage) desc) as rank from ingestion.sac_stds_avg_atd_by_grade as t where (date between startDate and endDate) and school_id = {school_id} group by t.grade",
                },
                "actions": {
                    "queries": {
                        "table": "select t.grade, dense_rank() over(order by avg(percentage) desc) as rank from ingestion.sac_stds_avg_atd_by_grade as t where school_id = {school_id} group by t.grade",
                    },
                    "level": "class"
                }
            }
