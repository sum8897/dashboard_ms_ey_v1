...
@Component({
  selector: 'app-student-details-big-number-card-one',
  templateUrl: './student-details-big-number-card-one.component.html',
  styleUrls: ['./student-details-big-number-card-one.component.scss']
})
export class StudentDetailsBigNumberCardOneComponent implements OnInit {

  reportName: string = 'studenet_details_bignumber_card_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Total CWSN Schools"
  };
  currentReportName: string = "Total CWSN Schools";
  minDate: any;
  maxDate: any;
