...
@Component({
  selector: 'app-cwsn-enrolments',
  templateUrl: './cwsn-enrolments.component.html',
  styleUrls: ['./cwsn-enrolments.component.scss']
})
export class CwsnEnrolmentsComponent implements OnInit {

  reportName: string = 'gradewise_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, 
    private csv: StudentsDetailsTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
