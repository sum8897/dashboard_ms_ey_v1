...
@Component({
  selector: 'app-students-details-card-big-number',
  templateUrl: './students-details-card-big-number.component.html',
  styleUrls: ['./students-details-card-big-number.component.scss']
})
export class StudentsDetailsCardBigNumberComponent implements OnInit {

  reportName: string = 'students_metrics_card';
  filters: any = [];
  levels: any;
  reportData: any = [];
