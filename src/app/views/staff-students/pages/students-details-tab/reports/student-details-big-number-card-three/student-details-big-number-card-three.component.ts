...
@Component({
  selector: 'app-student-details-big-number-card-three',
  templateUrl: './student-details-big-number-card-three.component.html',
  styleUrls: ['./student-details-big-number-card-three.component.scss']
})
export class StudentDetailsBigNumberCardThreeComponent implements OnInit {

  reportName: string = 'studenet_details_bignumber_card_three';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Total BPL Beneficiaries"
  };
  currentReportName: string = "Total BPL Beneficiaries";
  minDate: any;
  maxDate: any;
