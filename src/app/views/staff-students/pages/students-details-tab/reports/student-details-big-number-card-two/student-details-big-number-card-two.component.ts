...
@Component({
  selector: 'app-student-details-big-number-card-two',
  templateUrl: './student-details-big-number-card-two.component.html',
  styleUrls: ['./student-details-big-number-card-two.component.scss']
})
export class StudentDetailsBigNumberCardTwoComponent implements OnInit {

  reportName: string = 'studenet_details_bignumber_card_two';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "CWSN Enrolments"
  };
  currentReportName: string = "CWSN Enrolments";
  minDate: any;
  maxDate: any;
