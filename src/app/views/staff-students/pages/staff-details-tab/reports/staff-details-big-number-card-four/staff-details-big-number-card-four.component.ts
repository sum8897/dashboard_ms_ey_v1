...
@Component({
  selector: 'app-staff-details-big-number-card-four',
  templateUrl: './staff-details-big-number-card-four.component.html',
  styleUrls: ['./staff-details-big-number-card-four.component.scss']
})
export class StaffDetailsBigNumberCardFourComponent implements OnInit {

  reportName: string = 'staff_details_bignumber_card_four';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teaching Staff Total"
  };
  currentReportName: string = "Teaching Staff Total";
  minDate: any;
  maxDate: any;
