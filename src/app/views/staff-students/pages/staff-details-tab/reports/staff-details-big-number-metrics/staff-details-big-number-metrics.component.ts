...
@Component({
  selector: 'app-staff-details-big-number-metrics',
  templateUrl: './staff-details-big-number-metrics.component.html',
  styleUrls: ['./staff-details-big-number-metrics.component.scss']
})
export class StaffDetailsBigNumberMetricsComponent implements OnInit {

  reportName: string = 'staff_students_metrics_card';
  filters: any = [];
  levels: any;
  reportData: any = [];
