...
@Component({
  selector: 'app-staff-details-big-number-card-one',
  templateUrl: './staff-details-big-number-card-one.component.html',
  styleUrls: ['./staff-details-big-number-card-one.component.scss']
})
export class StaffDetailsBigNumberCardOneComponent implements OnInit {

  reportName: string = 'staff_details_bignumber_card_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teaching Staff Regular"
  };
  currentReportName: string = "Teaching Staff Regular";
  minDate: any;
  maxDate: any;
