...
@Component({
  selector: 'app-staff-details-big-number-card-three',
  templateUrl: './staff-details-big-number-card-three.component.html',
  styleUrls: ['./staff-details-big-number-card-three.component.scss']
})
export class StaffDetailsBigNumberCardThreeComponent implements OnInit {

  reportName: string = 'staff_details_bignumber_card_three';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teaching Staff Part Time/Guest"
  };
  currentReportName: string = "Teaching Staff Part Time/Guest";
  minDate: any;
  maxDate: any;
