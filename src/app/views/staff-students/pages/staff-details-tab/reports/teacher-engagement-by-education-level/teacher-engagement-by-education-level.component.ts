...
@Component({
  selector: 'app-teacher-engagement-by-education-level',
  templateUrl: './teacher-engagement-by-education-level.component.html',
  styleUrls: ['./teacher-engagement-by-education-level.component.scss']
})
export class TeacherEngagementByEducationLevelComponent implements OnInit {
  ...
  config;
  data;
  fileName: string = "Teachers Engagement by Education Level";
