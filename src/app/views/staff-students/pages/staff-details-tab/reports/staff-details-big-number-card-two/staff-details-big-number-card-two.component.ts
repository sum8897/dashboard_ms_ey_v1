...
@Component({
  selector: 'app-staff-details-big-number-card-two',
  templateUrl: './staff-details-big-number-card-two.component.html',
  styleUrls: ['./staff-details-big-number-card-two.component.scss']
})
export class StaffDetailsBigNumberCardTwoComponent implements OnInit {

  reportName: string = 'staff_details_bignumber_card_two';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teaching Staff Contract"
  };
  currentReportName: string = "Teaching Staff Contract";
  minDate: any;
  maxDate: any;
