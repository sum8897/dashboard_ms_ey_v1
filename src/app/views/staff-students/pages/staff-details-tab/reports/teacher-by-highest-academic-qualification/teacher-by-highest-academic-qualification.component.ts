...
@Component({
  selector: 'app-teacher-by-highest-academic-qualification',
  templateUrl: './teacher-by-highest-academic-qualification.component.html',
  styleUrls: ['./teacher-by-highest-academic-qualification.component.scss']
})
export class TeacherByHighestAcademicQualificationComponent implements OnInit {
  ...
  bigNumberReportData: any = {
    reportName: "Teachers By Highest Academic Qualification"
  };
  minDate: any;
  maxDate: any;
  ...
  filterIndex: any;
  rbacDetails: any;
  title = 'Teachers By Highest Academic Qualification';
  backUpData: any = [];
