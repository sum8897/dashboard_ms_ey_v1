...
@Component({
  selector: 'app-staff-details-big-number-card-five',
  templateUrl: './staff-details-big-number-card-five.component.html',
  styleUrls: ['./staff-details-big-number-card-five.component.scss']
})
export class StaffDetailsBigNumberCardFiveComponent implements OnInit {

  reportName: string = 'staff_details_bignumber_card_five';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Non Teaching Staff Total"
  };
  currentReportName: string = "Non Teaching Staff Total";
  minDate: any;
  maxDate: any;
