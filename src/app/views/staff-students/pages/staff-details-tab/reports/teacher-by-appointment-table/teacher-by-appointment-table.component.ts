...
@Component({
  selector: 'app-teacher-by-appointment-table',
  templateUrl: './teacher-by-appointment-table.component.html',
  styleUrls: ['./teacher-by-appointment-table.component.scss']
})
export class TeacherByAppointmentTableComponent implements OnInit {
