...
@Component({
  selector: 'app-improvements-status',
  templateUrl: './improvements-status.component.html',
  styleUrls: ['./improvements-status.component.scss']
})
export class ImprovementsStatusComponent implements OnInit {

  reportName: string = 'improvements_status';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Improvements Status"
  };
  title: string = 'Improvements Status'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
