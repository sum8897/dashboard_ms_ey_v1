...
import { config } from 'src/app/views/micro-improvements/config/microimprovements_config';

@Component({
  selector: 'app-micro-improvements-metrics',
  templateUrl: './micro-improvements-metrics.component.html',
  styleUrls: ['./micro-improvements-metrics.component.scss']
})
export class MicroImprovementsMetricsComponent implements OnInit {

  reportName: string = 'micro_improvements_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
