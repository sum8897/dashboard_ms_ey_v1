...
import { startCase } from 'lodash';import { IctClassroomTabComponent } from 'src/app/views/smart-classroom/pages/ict-classroom-tab/ict-classroom-tab.component';
...
export class SmartTableComponent implements OnInit, OnDestroy {
  ...
  filterIndex: any;
  rbacDetails: any;
  title = 'Status of ICT Smart Classroom';
