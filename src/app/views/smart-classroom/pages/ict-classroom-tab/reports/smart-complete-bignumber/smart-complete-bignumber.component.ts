...
@Component({
  selector: 'app-smart-complete-bignumber',
  templateUrl: './smart-complete-bignumber.component.html',
  styleUrls: ['./smart-complete-bignumber.component.scss']
})
export class SmartCompleteBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'smart_complete_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
