...
import { IctClassroomTabComponent } from 'src/app/views/smart-classroom/pages/ict-classroom-tab/ict-classroom-tab.component';
import { config } from 'src/app/views/smart-classroom/config/smart_classroom_config';

@Component({
  selector: 'app-smart-incomplete-bignumber',
  templateUrl: './smart-incomplete-bignumber.component.html',
  styleUrls: ['./smart-incomplete-bignumber.component.scss']
})
export class SmartIncompleteBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'smart_noncomplete_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private readonly _commonService: CommonService,
    private csv: IctClassroomTabComponent, 
