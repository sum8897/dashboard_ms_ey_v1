...
@Component({
  selector: 'app-pgi-bignumber-metrics',
  templateUrl: './pgi-bignumber-metrics.component.html',
  styleUrls: ['./pgi-bignumber-metrics.component.scss']
})
export class PgiBignumberMetricsComponent implements OnInit {
