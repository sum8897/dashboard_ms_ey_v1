        ...
        "filters": [
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(academic_year) as min_year,max(academic_year) as max_year,district_name as location,school_category, t.school_category, round(avg(sum_students_enrolled/sum_total_teachers),2) as total_teachers from ingestion.scl_stats_grade_wise_avg_pupil_tch_ratio_by_district as t left join ingestion.dimension_district as d on t.district_id = d.district_id group by t.district_id, district_name, t.school_category",
                    },
                    "level": "district"
                }
            },
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(academic_year) as min_year,max(academic_year) as max_year,block_name as location,school_category, t.school_category, round(avg(sum_students_enrolled/sum_total_teachers),2) as total_teachers from ingestion.scl_stats_grade_wise_avg_pupil_tch_ratio_by_block as t left join ingestion.dimension_block as d on t.block_id = d.block_id group by t.block_id, block_name, t.school_category",
                    },
                    "level": "block"
                }
            },
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(academic_year) as min_year,max(academic_year) as max_year,cluster_name as location,school_category, t.school_category, round(avg(sum_students_enrolled/sum_total_teachers),2) as total_teachers from ingestion.scl_stats_grade_wise_avg_pupil_tch_ratio_by_cluster as t left join ingestion.dimension_cluster as d on t.cluster_id = d.cluster_id group by t.cluster_id, cluster_name, t.school_category",
                    },
                    "level": "cluster"
                }
            },
            {
                ...
                "actions": {
                    "queries": {
                        "barChart": "select min(academic_year) as min_year,max(academic_year) as max_year,school_name as location,t.school_category, t.school_category, round(avg(sum_students_enrolled/sum_total_teachers),2) as total_teachers from ingestion.scl_stats_grade_wise_avg_pupil_tch_ratio_by_school as t left join ingestion.dimension_school as d on t.school_id = d.school_id group by t.school_id, school_name, t.school_category",
                    },
                    "level": "school"
                }
            }
