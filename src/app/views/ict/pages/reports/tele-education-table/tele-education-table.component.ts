...
@Component({
  selector: 'app-tele-education-table',
  templateUrl: './tele-education-table.component.html',
  styleUrls: ['./tele-education-table.component.scss']
})
export class TeleEducationTableComponent implements OnInit, OnDestroy {
  reportName: string = 'tele_education_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
