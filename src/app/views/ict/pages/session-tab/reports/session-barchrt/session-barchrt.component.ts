...
@Component({
  selector: 'app-session-barchrt',
  templateUrl: './session-barchrt.component.html',
  styleUrls: ['./session-barchrt.component.scss']
})
export class SessionBarchrtComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'session_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
  ...
  constructor(
    ...
    private csv: SessionTabComponent
  ) {
