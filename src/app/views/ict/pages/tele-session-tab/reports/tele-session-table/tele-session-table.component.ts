...
import { TeleSessionTabComponent } from 'src/app/views/ict/pages/tele-session-tab/tele-session-tab.component';
import { config } from 'src/app/views/ict/config/ict_config'
@Component({
  selector: 'app-tele-session-table',
  templateUrl: './tele-session-table.component.html',
  styleUrls: ['./tele-session-table.component.scss']
})
export class TeleSessionTableComponent implements OnInit, OnDestroy {
  reportName: string = 'session_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  filterIndex: any;
  rbacDetails: any;
  title = 'Status of Tele Education';
  ...
  constructor(
    ...
    private csv: TeleSessionTabComponent,
