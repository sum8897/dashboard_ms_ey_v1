...
// import { TeleSessionTableComponent } from './reports/tele-session-table/tele-session-table.component';
import { TeleSessionTableComponent } from 'src/app/views/ict/pages/tele-session-tab/reports/tele-session-table/tele-session-table.component';
import moment from 'moment';
@Component({
  selector: 'app-tele-session-tab',
  templateUrl: './tele-session-tab.component.html',
  styleUrls: ['./tele-session-tab.component.scss']
})
export class TeleSessionTabComponent implements OnInit, OnDestroy {
...
hasCommonFilters: boolean = true;
  ...
  //
  @ViewChild('teleSessionTable') teleSessionTable: TeleSessionTableComponent;
  ...
  async ngAfterViewInit(): Promise<void> {
      if (this.hasCommonFilters) {
          ...
          this.teleSessionTable?.getReportData({filterneed: this.hasCommonFilters, filterValues: this.filters.map((filter) => { return { ...filter, columnName: filter.valueProp, filterType: filter.id } }) },this.startDate,this.endDate);
