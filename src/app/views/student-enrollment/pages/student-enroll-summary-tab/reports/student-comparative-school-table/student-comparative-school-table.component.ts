...
@Component({
  selector: 'app-student-comparative-school-table',
  templateUrl: './student-comparative-school-table.component.html',
  styleUrls: ['./student-comparative-school-table.component.scss']
})
export class StudentComparativeSchoolTableComponent implements OnInit, OnDestroy {
  reportName: string = 'student_comparative_school';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: StudentEnrollSummaryTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
