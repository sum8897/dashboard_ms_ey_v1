...
@Component({
  selector: 'app-student-percentage-change-bignumber',
  templateUrl: './student-percentage-change-bignumber.component.html',
  styleUrls: ['./student-percentage-change-bignumber.component.scss']
})
export class StudentPercentageChangeBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'student_percentage_change_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
