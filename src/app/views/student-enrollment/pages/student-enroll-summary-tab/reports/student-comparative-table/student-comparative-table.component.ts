...
@Component({
  selector: 'app-student-comparative-table',
  templateUrl: './student-comparative-table.component.html',
  styleUrls: ['./student-comparative-table.component.scss']
})
export class StudentComparativeTableComponent implements OnInit, OnDestroy {
  reportName: string = 'student_comparative_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
