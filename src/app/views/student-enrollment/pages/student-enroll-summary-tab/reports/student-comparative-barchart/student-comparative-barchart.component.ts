...
import { DataService } from 'src/app/core/services/data.service';import { StudentEnrollSummaryTabComponent } from '../../student-enroll-summary-tab.component';
import { config } from 'src/app/views/student-enrollment/config/student_enrollment_config';

@Component({
  selector: 'app-student-comparative-barchart',
  templateUrl: './student-comparative-barchart.component.html',
  styleUrls: ['./student-comparative-barchart.component.scss']
})
export class StudentComparativeBarchartComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'student_comparative_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
  ...
  constructor(
    ...
    private csv: StudentEnrollSummaryTabComponent
  ) {
