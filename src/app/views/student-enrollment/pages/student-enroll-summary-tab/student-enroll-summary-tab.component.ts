...
@Component({
  selector: 'app-student-enroll-summary-tab',
  templateUrl: './student-enroll-summary-tab.component.html',
  styleUrls: ['./student-enroll-summary-tab.component.scss']
})
export class StudentEnrollSummaryTabComponent implements OnInit, OnDestroy {
