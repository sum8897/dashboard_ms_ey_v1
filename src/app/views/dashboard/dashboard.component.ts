...
export class DashboardComponent implements OnInit {
  ...
  onClickOfDashboardItem(cardInfo: IDashboardMenu | undefined): void {
    ...
    if (cardInfo) {
      if((cardInfo.title=='UDISE School Infrastructure' || cardInfo.title=='School General' || cardInfo.title=='PAS' || cardInfo.title=='Staff and Students' || cardInfo.title=='PGI and School Safety' || cardInfo.title=='Staff' || cardInfo.title=='Students Attendance Details')  && (localStorage.getItem('login_access')=='login_public')){
