...
@Component({
  selector: 'app-grade-category-wise-enrollment',
  templateUrl: './grade-category-wise-enrollment.component.html',
  styleUrls: ['./grade-category-wise-enrollment.component.scss']
})
export class GradeCategoryWiseEnrollmentComponent implements OnInit {
