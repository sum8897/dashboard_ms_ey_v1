...
@Component({
  selector: 'app-gender-wise-student-enrollment',
  templateUrl: './gender-wise-student-enrollment.component.html',
  styleUrls: ['./gender-wise-student-enrollment.component.scss']
})
export class GenderWiseStudentEnrollmentComponent implements OnInit {
  ...
  config;
  data;
  fileName: string = "Gender Wise Student Enrollment";
  reportName: string = 'gender_wise_student_enrollment';
  filters: any = [];
  levels: any;
  tableReportData: any;
  startDate: any;
