...
@Component({
  selector: "app-student-average-absent-bignumber",
  templateUrl: "./student-average-absent-bignumber.component.html",
  styleUrls: ["./student-average-absent-bignumber.component.scss"],
})
  ...
  implements OnInit, OnDestroy
{
  ...
  bigNumberReportData: any = {
    reportName: "Average % Present",
  };
  currentReportName: string = "Average % Present";
  minDate: any;
  maxDate: any;
