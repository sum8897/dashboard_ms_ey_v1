...
@Component({
  selector: "app-student-average-absent-table",
  templateUrl: "./student-average-absent-table.component.html",
  styleUrls: ["./student-average-absent-table.component.scss"],
})
export class StudentAverageAbsentTableComponent implements OnInit, OnDestroy {
  reportName: string = "student_average_absent_table";
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  bigNumberReportData: any = {
    reportName: "Average Student Absent",
  };
  minDate: any;
  maxDate: any;
