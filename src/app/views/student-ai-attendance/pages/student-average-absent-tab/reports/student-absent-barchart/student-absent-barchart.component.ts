...
@Component({
  selector: "app-student-absent-barchart",
  templateUrl: "./student-absent-barchart.component.html",
  styleUrls: ["./student-absent-barchart.component.scss"],
})
export class StudentAbsentBarchartComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private csv: StudentAverageAbsentTabComponent
  ) {
    ...
    if (this.drillDownDetails !== undefined) {
      ...
      Object.keys(queries).forEach(async (key: any) => {
        ...
        if (query && key === "table" && filterneed) {
          ...
          this._dataService.extraLine(reportData, config, "perc_absent");
