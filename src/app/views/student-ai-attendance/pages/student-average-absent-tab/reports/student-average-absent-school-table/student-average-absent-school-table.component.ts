...
@Component({
  selector: "app-student-average-absent-school-table",
  templateUrl: "./student-average-absent-school-table.component.html",
  styleUrls: ["./student-average-absent-school-table.component.scss"],
})
