...
@Component({
  selector: 'app-student-trendline',
  templateUrl: './student-trendline.component.html',
  styleUrls: ['./student-trendline.component.scss']
})
export class StudentTrendlineComponent implements OnInit, OnDestroy {
