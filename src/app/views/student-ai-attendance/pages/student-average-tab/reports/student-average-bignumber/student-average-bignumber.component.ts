...
@Component({
  selector: 'app-student-average-bignumber',
  templateUrl: './student-average-bignumber.component.html',
  styleUrls: ['./student-average-bignumber.component.scss']
})
export class StudentAverageBignumberComponent implements OnInit, OnDestroy {
