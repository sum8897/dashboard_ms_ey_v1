...
import { config } from './config/student_ai_attendance_config';

@Component({
  selector: 'app-student-ai-attendance',
  templateUrl: './student-ai-attendance.component.html',
  styleUrls: ['./student-ai-attendance.component.scss']
})
export class StudentAiAttendanceComponent implements OnInit {
  loadTabs = false;
  tabIndex;
  rbacDetails: any;
  selectedTabLabel;
  tabs: any = [];
  programName : any = 'studentAiAttendance'
