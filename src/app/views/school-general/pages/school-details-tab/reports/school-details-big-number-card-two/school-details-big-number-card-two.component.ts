...
@Component({
  selector: 'app-school-details-big-number-card-two',
  templateUrl: './school-details-big-number-card-two.component.html',
  styleUrls: ['./school-details-big-number-card-two.component.scss']
})
export class SchoolDetailsBigNumberCardTwoComponent implements OnInit {

  reportName: string = 'school_details_bignumber_card_two';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Student Enrollment"
  };
  currentReportName: string = "Student Enrollment";
  minDate: any;
  maxDate: any;
