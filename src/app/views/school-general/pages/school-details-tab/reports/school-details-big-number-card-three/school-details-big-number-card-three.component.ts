...
@Component({
  selector: 'app-school-details-big-number-card-three',
  templateUrl: './school-details-big-number-card-three.component.html',
  styleUrls: ['./school-details-big-number-card-three.component.scss']
})
export class SchoolDetailsBigNumberCardThreeComponent implements OnInit {

  reportName: string = 'school_details_bignumber_card_three';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Active Schools"
  };
  currentReportName: string = "Active Schools";
  minDate: any;
  maxDate: any;
