...
@Component({
  selector: 'app-school-details-big-number-card-one',
  templateUrl: './school-details-big-number-card-one.component.html',
  styleUrls: ['./school-details-big-number-card-one.component.scss']
})
export class SchoolDetailsBigNumberCardOneComponent implements OnInit {

  reportName: string = 'school_details_bignumber_card_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teaching Staff"
  };
  currentReportName: string = "Teaching Staff";
  minDate: any;
  maxDate: any;
