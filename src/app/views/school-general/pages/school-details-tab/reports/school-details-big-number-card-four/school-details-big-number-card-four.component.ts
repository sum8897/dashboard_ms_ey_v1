...
@Component({
  selector: 'app-school-details-big-number-card-four',
  templateUrl: './school-details-big-number-card-four.component.html',
  styleUrls: ['./school-details-big-number-card-four.component.scss']
})
export class SchoolDetailsBigNumberCardFourComponent implements OnInit {

  reportName: string = 'school_details_bignumber_card_four';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "RTE Compliant Schools (Private Unaided)"
  };
  currentReportName: string = "RTE Compliant Schools (Private Unaided)";
  minDate: any;
  maxDate: any;
