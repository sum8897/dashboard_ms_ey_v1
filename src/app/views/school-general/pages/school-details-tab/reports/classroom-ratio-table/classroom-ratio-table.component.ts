...
@Component({
  selector: 'app-classroom-ratio-table',
  templateUrl: './classroom-ratio-table.component.html',
  styleUrls: ['./classroom-ratio-table.component.scss']
})
export class ClassroomRatioTableComponent implements OnInit, OnDestroy {
  reportName: string = 'classroom_ratio_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Student Classroom Ratio"
  };
  minDate: any;
  maxDate: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: SchoolDetailsTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
