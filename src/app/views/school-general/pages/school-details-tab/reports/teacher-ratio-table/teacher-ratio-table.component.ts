...
@Component({
  selector: 'app-teacher-ratio-table',
  templateUrl: './teacher-ratio-table.component.html',
  styleUrls: ['./teacher-ratio-table.component.scss']
})
export class TeacherRatioTableComponent implements OnInit, OnDestroy {
  reportName: string = 'teacher_ratio_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Pupil Teacher Ratio"
  };
  minDate: any;
  maxDate: any;
