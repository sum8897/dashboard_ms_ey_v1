...
@Component({
  selector: 'app-school-bignumber',
  templateUrl: './school-bignumber.component.html',
  styleUrls: ['./school-bignumber.component.scss']
})
export class SchoolBignumberComponent implements OnInit {
