...
@Component({
  selector: 'app-net-enroll-table',
  templateUrl: './net-enroll-table.component.html',
  styleUrls: ['./net-enroll-table.component.scss']
})
export class NetEnrollTableComponent implements OnInit, OnDestroy {
  reportName: string = 'net_enroll_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: KeyIndicatorsTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
