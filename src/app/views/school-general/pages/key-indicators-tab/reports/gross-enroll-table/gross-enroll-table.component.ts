...
@Component({
  selector: 'app-gross-enroll-table',
  templateUrl: './gross-enroll-table.component.html',
  styleUrls: ['./gross-enroll-table.component.scss']
})
export class GrossEnrollTableComponent implements OnInit, OnDestroy {
  reportName: string = 'gross_enroll_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
  ...
  constructor(
    ...
    private csv: KeyIndicatorsTabComponent,
