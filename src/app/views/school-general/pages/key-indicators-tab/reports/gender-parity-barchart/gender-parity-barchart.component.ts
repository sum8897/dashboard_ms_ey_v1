...
@Component({
  selector: 'app-gender-parity-barchart',
  templateUrl: './gender-parity-barchart.component.html',
  styleUrls: ['./gender-parity-barchart.component.scss']
})
export class GenderParityBarchartComponent implements OnInit, OnDestroy {
