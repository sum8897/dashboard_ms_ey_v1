...
@Component({
  selector: 'app-disanc-survey-bar',
  templateUrl: './disanc-survey-bar.component.html',
  styleUrls: ['./disanc-survey-bar.component.scss']
})
export class DisancSurveyBarComponent implements OnInit {

  reportName: string = 'disanc_survey_bar';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "DiSanc Survey"
  };
  title: string = 'DiSanc Survey'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
