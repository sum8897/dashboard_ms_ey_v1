...
@Component({
  selector: 'app-ncf-bignumber',
  templateUrl: './ncf-bignumber.component.html',
  styleUrls: ['./ncf-bignumber.component.scss']
})
export class NcfBignumberComponent implements OnInit {

  reportName: string = 'ncf_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
