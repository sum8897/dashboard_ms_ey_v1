...
@Component({
  selector: 'app-teacher-barchart',
  templateUrl: './teacher-barchart.component.html',
  styleUrls: ['./teacher-barchart.component.scss']
})
export class TeacherBarchartComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'teacher_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
