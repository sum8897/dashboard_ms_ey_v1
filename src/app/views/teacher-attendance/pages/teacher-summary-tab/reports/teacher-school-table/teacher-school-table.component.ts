...
@Component({
  selector: 'app-teacher-school-table',
  templateUrl: './teacher-school-table.component.html',
  styleUrls: ['./teacher-school-table.component.scss']
})
export class TeacherSchoolTableComponent implements OnInit, OnDestroy {
  reportName: string = 'teacher_average_school';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  filterIndex: any;
  rbacDetails: any;
  title = ' School Wise % Average Teachers Present';
  backUpData: any = [];
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: TeacherSummaryTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
