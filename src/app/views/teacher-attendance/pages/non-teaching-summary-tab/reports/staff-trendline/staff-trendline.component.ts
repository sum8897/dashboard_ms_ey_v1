...
@Component({
  selector: 'app-staff-trendline',
  templateUrl: './staff-trendline.component.html',
  styleUrls: ['./staff-trendline.component.scss']
})
export class StaffTrendlineComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'staff_trendchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
