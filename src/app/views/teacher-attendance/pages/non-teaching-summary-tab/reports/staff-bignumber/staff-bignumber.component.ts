...
@Component({
  selector: 'app-staff-bignumber',
  templateUrl: './staff-bignumber.component.html',
  styleUrls: ['./staff-bignumber.component.scss']
})
export class StaffBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'staff_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  currentReportName: string = "Average % Non Teaching Staff present";
  minDate: any;
  maxDate: any;
