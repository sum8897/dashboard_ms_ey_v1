...
@Component({
  selector: 'app-staff-school-table',
  templateUrl: './staff-school-table.component.html',
  styleUrls: ['./staff-school-table.component.scss']
})
export class StaffSchoolTableComponent implements OnInit, OnDestroy {
  reportName: string = 'staff_average_school';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Average Non Teaching Staff Present"
  };
  minDate: any;
  maxDate: any;
  ...
  filterIndex: any;
  rbacDetails: any;
  title = ' School Wise % Average Non Teaching Staff Present';
  backUpData: any = [];
