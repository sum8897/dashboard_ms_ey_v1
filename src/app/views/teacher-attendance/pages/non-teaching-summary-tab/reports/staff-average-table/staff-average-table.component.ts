...
@Component({
  selector: 'app-staff-average-table',
  templateUrl: './staff-average-table.component.html',
  styleUrls: ['./staff-average-table.component.scss']
})
export class StaffAverageTableComponent implements OnInit, OnDestroy {
  reportName: string = 'staff_average_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
