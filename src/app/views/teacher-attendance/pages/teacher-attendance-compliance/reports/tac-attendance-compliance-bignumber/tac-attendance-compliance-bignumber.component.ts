...
@Component({
  selector: 'app-tac-attendance-compliance-bignumber',
  templateUrl: './tac-attendance-compliance-bignumber.component.html',
  styleUrls: ['./tac-attendance-compliance-bignumber.component.scss']
})
export class TacAttendanceComplianceBignumberComponent implements OnInit {

  reportName: string = 'tac_average_attendance_compliance_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
