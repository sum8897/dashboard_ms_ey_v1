...
@Component({
  selector: 'app-teaching-map',
  templateUrl: './teaching-map.component.html',
  styleUrls: ['./teaching-map.component.scss']
})
export class TeachingMapComponent implements OnInit {

  reportName: string = 'teaching_map';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Map View of Teacher Attendance"
  };
  title: string = ''
  selectedYear: any;
  selectedMonth: any;
