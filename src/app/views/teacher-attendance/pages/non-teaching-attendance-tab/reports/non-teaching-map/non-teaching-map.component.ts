...
@Component({
  selector: 'app-non-teaching-map',
  templateUrl: './non-teaching-map.component.html',
  styleUrls: ['./non-teaching-map.component.scss']
})
export class NonTeachingMapComponent implements OnInit {

  reportName: string = 'non_teaching_map';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Map View of Non Teaching Staff Attendance"
  };
  title: string = ''
  selectedYear: any;
  selectedMonth: any;
