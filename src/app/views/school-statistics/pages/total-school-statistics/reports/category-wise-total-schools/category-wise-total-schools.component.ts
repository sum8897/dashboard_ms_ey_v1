...
@Component({
  ...
  templateUrl: './category-wise-total-schools.component.html',
  styleUrls: ['./category-wise-total-schools.component.scss']
})
export class CategoryWiseTotalSchoolsComponent implements OnInit {
  ...
  config;
  data;
  fileName: string = "Category Wise Total Schools";
  reportName: string = 'scl_stat_Category_wise_total_schools';
  filters: any = [];
  levels: any;
  tableReportData: any;
  startDate: any;
