...
@Component({
  selector: 'app-big-number-three',
  templateUrl: './big-number-three.component.html',
  styleUrls: ['./big-number-three.component.scss']
})
export class BigNumberThreeComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_three';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Youth Club Constituted"
  };
  currentReportName: string = "Youth Club Constituted";
  minDate: any;
  maxDate: any;
