...
@Component({
  selector: 'app-performing-indicators-table-two',
  templateUrl: './performing-indicators-table-two.component.html',
  styleUrls: ['./performing-indicators-table-two.component.scss']
})
export class PerformingIndicatorsTableTwoComponent implements OnInit {
  ...
  bigNumberReportData: any = {
    reportName: "Performing Indicators for Govt and Aided Schools"
  };
  minDate: any;
  maxDate: any;
  ...
  filterIndex: any;
  rbacDetails: any;
  title = 'Performing Indicators for Govt and Aided Schools';
  backUpData: any = [];
  ...
  constructor(private spinner: NgxSpinnerService, private readonly _commonService: CommonService, private csv: PerformingIndicatorsTabsComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService, private readonly _reportDrilldownService: ReportDrilldownService, private readonly _criteriaService: CriteriaService, private readonly _dataService: DataService) {
