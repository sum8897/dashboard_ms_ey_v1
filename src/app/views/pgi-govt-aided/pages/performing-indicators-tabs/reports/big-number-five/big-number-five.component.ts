...
@Component({
  selector: 'app-big-number-five',
  templateUrl: './big-number-five.component.html',
  styleUrls: ['./big-number-five.component.scss']
})
export class BigNumberFiveComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_five';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Issued Teacher Id"
  };
  currentReportName: string = "Issued Teacher Id";
  minDate: any;
  maxDate: any;
