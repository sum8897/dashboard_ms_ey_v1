...
@Component({
  selector: 'app-big-number-two',
  templateUrl: './big-number-two.component.html',
  styleUrls: ['./big-number-two.component.scss']
})
export class BigNumberTwoComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_two';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Vidya Pravesh Module Adopted"
  };
  currentReportName: string = "Vidya Pravesh Module Adopted";
  minDate: any;
  maxDate: any;
