...
@Component({
  selector: 'app-big-number-six',
  templateUrl: './big-number-six.component.html',
  styleUrls: ['./big-number-six.component.scss']
})
export class BigNumberSixComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_six';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "SSSA Self Certification"
  };
  currentReportName: string = "SSSA Self Certification";
  minDate: any;
  maxDate: any;
