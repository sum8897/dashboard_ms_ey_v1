...
@Component({
  selector: 'app-performing-indicators-table',
  templateUrl: './performing-indicators-table.component.html',
  styleUrls: ['./performing-indicators-table.component.scss']
})
export class PerformingIndicatorsTableComponent implements OnInit {

  reportName: string = 'performing_wise_table_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  reportsData: any[] = []
