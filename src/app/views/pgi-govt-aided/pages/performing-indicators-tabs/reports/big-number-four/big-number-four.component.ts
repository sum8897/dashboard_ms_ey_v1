...
@Component({
  selector: 'app-big-number-four',
  templateUrl: './big-number-four.component.html',
  styleUrls: ['./big-number-four.component.scss']
})
export class BigNumberFourComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_four';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Eco Club Constituted"
  };
  currentReportName: string = "Eco Club Constituted";
  minDate: any;
  maxDate: any;
