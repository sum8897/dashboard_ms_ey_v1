...
@Component({
  selector: 'app-performing-indicators-big-number-metrics',
  templateUrl: './performing-indicators-big-number-metrics.component.html',
  styleUrls: ['./performing-indicators-big-number-metrics.component.scss']
})
export class PerformingIndicatorsBigNumberMetricsComponent implements OnInit {

  reportName: string = 'performing_indicators_metrics_card';
  filters: any = [];
  levels: any;
  reportData: any = [];
