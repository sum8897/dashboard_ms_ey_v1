...
@Component({
  selector: 'app-big-number-photographs',
  templateUrl: './big-number-photographs.component.html',
  styleUrls: ['./big-number-photographs.component.scss']
})
export class BigNumberPhotographsComponent implements OnInit {

  reportName: string = 'performing_bignumber_card_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Teacher Photographs Displayed"
  };
  currentReportName: string = "Teacher Photographs Displayed";
  minDate: any;
  maxDate: any;
  ...
  constructor(private readonly _commonService: CommonService,
    private csv: PerformingIndicatorsTabsComponent, 
