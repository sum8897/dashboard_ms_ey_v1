...
@Component({
  selector: 'app-school-safety-first-bar-chart',
  templateUrl: './school-safety-first-bar-chart.component.html',
  styleUrls: ['./school-safety-first-bar-chart.component.scss']
})
