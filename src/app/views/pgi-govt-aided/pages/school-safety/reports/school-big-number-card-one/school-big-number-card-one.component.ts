...
@Component({
  selector: 'app-school-big-number-card-one',
  templateUrl: './school-big-number-card-one.component.html',
  styleUrls: ['./school-big-number-card-one.component.scss']
})
export class SchoolBigNumberCardOneComponent implements OnInit {

  reportName: string = 'school_safety_bignumber_card_one';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Schools with SDM Plan"
  };
  currentReportName: string = "Schools with SDM Plan";
  minDate: any;
  maxDate: any;
