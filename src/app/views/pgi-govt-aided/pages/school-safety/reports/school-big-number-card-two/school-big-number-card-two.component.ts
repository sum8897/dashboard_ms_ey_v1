...
@Component({
  selector: 'app-school-big-number-card-two',
  templateUrl: './school-big-number-card-two.component.html',
  styleUrls: ['./school-big-number-card-two.component.scss']
})
export class SchoolBigNumberCardTwoComponent implements OnInit {

  reportName: string = 'school_safety_bignumber_card_two';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Schools with Structural audit"
  };
  currentReportName: string = "Schools with Structural audit";
  minDate: any;
  maxDate: any;
