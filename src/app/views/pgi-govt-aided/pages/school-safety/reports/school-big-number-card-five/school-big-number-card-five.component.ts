...
@Component({
  selector: 'app-school-big-number-card-five',
  templateUrl: './school-big-number-card-five.component.html',
  styleUrls: ['./school-big-number-card-five.component.scss']
})
export class SchoolBigNumberCardFiveComponent implements OnInit {

  reportName: string = 'school_safety_bignumber_card_five';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Schools with Nodal Safety Teacher"
  };
  currentReportName: string = "Schools with Nodal Safety Teacher";
  minDate: any;
  maxDate: any;
