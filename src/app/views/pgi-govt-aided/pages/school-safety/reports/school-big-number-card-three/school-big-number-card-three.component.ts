...
@Component({
  selector: 'app-school-big-number-card-three',
  templateUrl: './school-big-number-card-three.component.html',
  styleUrls: ['./school-big-number-card-three.component.scss']
})
export class SchoolBigNumberCardThreeComponent implements OnInit {

  reportName: string = 'school_safety_bignumber_card_three';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Schools with CCTV Camera"
  };
  currentReportName: string = "Schools with CCTV Camera";
  minDate: any;
  maxDate: any;
