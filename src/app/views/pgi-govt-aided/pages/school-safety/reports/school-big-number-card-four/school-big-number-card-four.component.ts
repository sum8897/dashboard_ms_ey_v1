...
@Component({
  selector: 'app-school-big-number-card-four',
  templateUrl: './school-big-number-card-four.component.html',
  styleUrls: ['./school-big-number-card-four.component.scss']
})
export class SchoolBigNumberCardFourComponent implements OnInit {

  reportName: string = 'school_safety_bignumber_card_four';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Schools with Fire Exit"
  };
  currentReportName: string = "Schools with Fire Exit";
  minDate: any;
  maxDate: any;
