...
@Component({
  selector: 'app-school-safety-big-number-metrics',
  templateUrl: './school-safety-big-number-metrics.component.html',
  styleUrls: ['./school-safety-big-number-metrics.component.scss']
})
export class SchoolSafetyBigNumberMetricsComponent implements OnInit {

  
  reportName: string = 'school_safety_cards_data';
  filters: any = [];
  levels: any;
  reportData: any = [];
