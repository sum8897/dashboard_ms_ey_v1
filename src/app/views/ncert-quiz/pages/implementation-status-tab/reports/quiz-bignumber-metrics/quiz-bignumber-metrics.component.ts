...
import { config } from 'src/app/views/ncert-quiz/config/quiz_config';

@Component({
  selector: 'app-quiz-bignumber-metrics',
  templateUrl: './quiz-bignumber-metrics.component.html',
  styleUrls: ['./quiz-bignumber-metrics.component.scss']
})
export class QuizBignumberMetricsComponent implements OnInit {
  reportName: string = 'quiz_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];
