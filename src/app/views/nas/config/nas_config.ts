        ...
        "filters": [
            {
                ...
                "actions": {
                    "queries": {
                        "bigNumber1": "select count as total_schools from datasets.nas_performance_state",
                        "bigNumber2": "select sum as students_surveyed from datasets.nas_students_surveyed_state",
                        "bigNumber3": "select sum as total_teachers from datasets.nas_no_of_teachers_state",
                    },
                    "level": "district"
                }
            },
