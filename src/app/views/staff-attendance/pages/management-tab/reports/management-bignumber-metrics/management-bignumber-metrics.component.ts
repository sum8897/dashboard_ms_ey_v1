...
import { ManagementTabComponent } from 'src/app/views/staff-attedance/pages/management-tab/management-tab.component';

@Component({
  selector: 'app-management-bignumber-metrics',
  templateUrl: './management-bignumber-metrics.component.html',
  styleUrls: ['./management-bignumber-metrics.component.scss']
})
export class ManagementBignumberMetricsComponent implements OnInit {
