...
@Component({
  selector: 'app-management-bignumberthree-metrics',
  templateUrl: './management-bignumberthree-metrics.component.html',
  styleUrls: ['./management-bignumberthree-metrics.component.scss']
})
export class ManagementBignumberthreeMetricsComponent implements OnInit {

  reportName: string = 'management_bignumberthree';
        filters: any = [];
        levels: any;
        tableReportData: any;
        bigNumberReportData: any = {
          reportName: "Total Govt Teachers"
        };
        currentReportName: string = "Total Govt Teachers";
        minDate: any;
        maxDate: any;
