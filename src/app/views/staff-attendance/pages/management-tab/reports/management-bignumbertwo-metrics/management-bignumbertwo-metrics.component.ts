...
@Component({
  selector: 'app-management-bignumbertwo-metrics',
  templateUrl: './management-bignumbertwo-metrics.component.html',
  styleUrls: ['./management-bignumbertwo-metrics.component.scss']
})
export class ManagementBignumbertwoMetricsComponent implements OnInit {

    reportName: string = 'management_bignumbertwo';
   filters: any = [];
      levels: any;
      tableReportData: any;
      bigNumberReportData: any = {
        reportName: "Govt Teachers Absent"
      };
      currentReportName: string = "Govt Teachers Absent";
      minDate: any;
      maxDate: any;
