...
@Component({
  selector: 'app-management-bignumberone-metrics',
  templateUrl: './management-bignumberone-metrics.component.html',
  styleUrls: ['./management-bignumberone-metrics.component.scss']
})
export class ManagementBignumberoneMetricsComponent implements OnInit {

  reportName: string = 'management_bignumberone';
     filters: any = [];
     levels: any;
     tableReportData: any;
     bigNumberReportData: any = {
       reportName: "Govt Teachers Present"
     };
     currentReportName: string = "Govt Teachers Present";
     minDate: any;
     maxDate: any;
