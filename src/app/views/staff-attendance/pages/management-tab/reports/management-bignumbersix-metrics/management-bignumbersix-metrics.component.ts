...
@Component({
  selector: 'app-management-bignumbersix-metrics',
  templateUrl: './management-bignumbersix-metrics.component.html',
  styleUrls: ['./management-bignumbersix-metrics.component.scss']
})
export class ManagementBignumbersixMetricsComponent implements OnInit {

  reportName: string = 'management_bignumbersix';
        filters: any = [];
        levels: any;
        tableReportData: any;
        bigNumberReportData: any = {
          reportName: "Total Govt Aided Teachers"
        };
        currentReportName: string = "Total Govt Aided Teachers";
        minDate: any;
        maxDate: any;
