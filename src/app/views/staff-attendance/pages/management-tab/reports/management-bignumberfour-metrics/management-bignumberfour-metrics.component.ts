...
@Component({
  selector: 'app-management-bignumberfour-metrics',
  templateUrl: './management-bignumberfour-metrics.component.html',
  styleUrls: ['./management-bignumberfour-metrics.component.scss']
})
export class ManagementBignumberfourMetricsComponent implements OnInit {

  reportName: string = 'management_bignumberfour';
        filters: any = [];
        levels: any;
        tableReportData: any;
        bigNumberReportData: any = {
          reportName: "Govt Aided Teachers Present"
        };
        currentReportName: string = "Govt Aided Teachers Present";
        minDate: any;
        maxDate: any;
