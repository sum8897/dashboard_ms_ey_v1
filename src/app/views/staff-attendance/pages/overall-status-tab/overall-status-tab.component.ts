...
@Component({
  ...
  templateUrl: './overall-status-tab.component.html',
  styleUrls: ['./overall-status-tab.component.scss']
})
export class OverallStatusTabComponent implements OnInit {
  ...
  bigNumberReports: any = {};
      ...
      bigNumberMetrics: any = [];
        ...
        tabLabel:any='Overall Status';
      
        //added for full school report download
        // title = "Download School Report"
        schoolReportsData: any[] = [];
        pagereportName = "Overall Status"
     @ViewChild('performing_wise_table_one') performing_wise_table_one: OverallStatusTableComponent;
