...
@Component({
  selector: "app-overall-status-bignumberone-metrics",
  templateUrl: "./overall-status-bignumberone-metrics.component.html",
  styleUrls: ["./overall-status-bignumberone-metrics.component.scss"],
})
export class OverallStatusBignumberoneMetricsComponent implements OnInit {
