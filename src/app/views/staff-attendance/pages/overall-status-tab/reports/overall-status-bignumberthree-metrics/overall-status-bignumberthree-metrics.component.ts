...
@Component({
  selector: "app-overall-status-bignumberthree-metrics",
  templateUrl: "./overall-status-bignumberthree-metrics.component.html",
  styleUrls: ["./overall-status-bignumberthree-metrics.component.scss"],
})
export class OverallStatusBignumberthreeMetricsComponent implements OnInit {
  reportName: string = "overall_status_bignumberthree";
  filters: any = [];
  levels: any;
  tableReportData: any;
  ...
  currentReportName: string = "Total Teachers";
  minDate: any;
  maxDate: any;
  ...
  constructor(
    ...
    private csv: OverallStatusTabComponent,
  ...
  ngOnInit(): void {
    this.drillDownSubscription = this._rbacService
      .getRbacDetails()
      .subscribe((rbacDetails: any) => {
        ...
        .subscribe((res: any) => {
          if (res) {
            ...
            this._benchmarkService.getValues().subscribe((obj: any) => {
              let level = this.drillDownLevel
                ? this.drillDownLevel
                : this.rbacDetails.role;
              if (
                obj &&
                Object.keys(obj).includes(this.reportName) &&
                rows[0]?.[property]
              ) {
                benchmarkValues = {
                  ...obj,
      ...
      case 2:
        ...
        this.bigNumberReportData = {
          ...
          reportName:
            ...
            ` for ${event?.district_name || event[event.district]} District`,
        };
        break;
      case 3:
        drillDownDetails = {
        ...
        this.bigNumberReportData = {
          ...
          reportName:
            this.currentReportName +
            ` for ${event?.block_name || event[event.block]} Block`,
        };
        break;
      case 4:
        drillDownDetails = {
        ...
        this.bigNumberReportData = {
          ...
          reportName:
            this.currentReportName +
            ` for ${event?.cluster_name || event[event.cluster]} Cluster`,
        };
        break;
      case 5:
        drillDownDetails = {
        ...
        this.bigNumberReportData = {
          ...
          reportName:
            this.currentReportName +
            ` for ${event?.school_name || event[event.school]} School`,
        };
        break;
    }
