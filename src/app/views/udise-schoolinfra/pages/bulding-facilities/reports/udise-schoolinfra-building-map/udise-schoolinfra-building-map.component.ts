...
@Component({
  selector: 'app-udise-schoolinfra-building-map',
  templateUrl: './udise-schoolinfra-building-map.component.html',
  styleUrls: ['./udise-schoolinfra-building-map.component.scss']
})
export class UdiseSchoolinfraBuildingMapComponent implements OnInit {



  reportName: string = 'building';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Bulding & Facilities"
  };
  title: string = 'Bulding & Facilities'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
