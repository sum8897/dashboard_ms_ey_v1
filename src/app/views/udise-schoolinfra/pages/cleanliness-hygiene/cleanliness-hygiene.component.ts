...
import { UdiseSchoolinfraCleanMapComponent } from './reports/udise-schoolinfra-clean-map/udise-schoolinfra-clean-map.component'; 
import { WrapperService } from 'src/app/core/services/wrapper.service';
import { RbacService } from 'src/app/core/services/rbac-service.service';
import { config } from '../../config/udise_schoolinfra_config';
import {MatCheckboxModule} from '@angular/material/checkbox';
@Component({
  selector: 'app-cleanliness-hygiene',
  templateUrl: './cleanliness-hygiene.component.html',
  styleUrls: ['./cleanliness-hygiene.component.scss']
})
export class CleanlinessHygieneComponent implements OnInit {
  ...
  tabLabel:any='Cleanliness & Hygiene';
  @ViewChild('udiseschoolinframap') udiseSchoolinfraMap:UdiseSchoolinfraCleanMapComponent ;
