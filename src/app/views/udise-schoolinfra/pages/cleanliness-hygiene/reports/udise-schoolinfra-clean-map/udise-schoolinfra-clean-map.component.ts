...
@Component({
  selector: 'app-udise-schoolinfra-clean-map',
  templateUrl: './udise-schoolinfra-clean-map.component.html',
  styleUrls: ['./udise-schoolinfra-clean-map.component.scss']
})
export class UdiseSchoolinfraCleanMapComponent implements OnInit {



  reportName: string = 'clean';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Cleanliness & Hygiene"
  };
  title: string = 'Cleanliness & Hygiene'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
