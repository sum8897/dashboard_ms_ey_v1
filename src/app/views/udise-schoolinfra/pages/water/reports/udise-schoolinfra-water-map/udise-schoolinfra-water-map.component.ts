...
@Component({
  selector: 'app-udise-schoolinfra-water-map',
  templateUrl: './udise-schoolinfra-water-map.component.html',
  styleUrls: ['./udise-schoolinfra-water-map.component.scss']
})
export class UdiseSchoolinfraWaterMapComponent implements OnInit {


  reportName: string = 'water';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Water"
