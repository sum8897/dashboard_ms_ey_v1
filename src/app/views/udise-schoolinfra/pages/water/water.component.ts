...
import { UdiseSchoolinfraWaterMapComponent } from './reports/udise-schoolinfra-water-map/udise-schoolinfra-water-map.component';
...
export class WaterComponent implements OnInit {
    ...
    tabLabel:any='Water';
    @ViewChild('udiseschoolinframap') udiseSchoolinfraMap:UdiseSchoolinfraWaterMapComponent ;
