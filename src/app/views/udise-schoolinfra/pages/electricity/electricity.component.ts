...
import { UdiseSchoolinfraMapComponent } from './reports/udise-schoolinfra-map/udise-schoolinfra-map.component';
...
export class ElectricityComponent implements OnInit {
  ...
  bigNumberReports: any = {};
    ...
    tabLabel:any='Electricity';
    @ViewChild('udiseschoolinframap') udiseSchoolinfraMap:UdiseSchoolinfraMapComponent ;
