...
@Component({
  selector: 'app-udise-schoolinfra-toilet-map',
  templateUrl: './udise-schoolinfra-toilet-map.component.html',
  styleUrls: ['./udise-schoolinfra-toilet-map.component.scss']
})
export class UdiseSchoolinfraToiletMapComponent implements OnInit {


  reportName: string = 'toilet';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Toilet & Urinal"
  };
  title: string = 'Toilet & Urinal'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
