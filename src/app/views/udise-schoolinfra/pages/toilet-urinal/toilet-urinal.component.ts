...
import { UdiseSchoolinfraToiletMapComponent } from './reports/udise-schoolinfra-toilet-map/udise-schoolinfra-toilet-map.component'; 
import { WrapperService } from 'src/app/core/services/wrapper.service';
import { RbacService } from 'src/app/core/services/rbac-service.service';
import { config } from '../../config/udise_schoolinfra_config';
import {MatCheckboxModule} from '@angular/material/checkbox';
@Component({
  selector: 'app-toilet-urinal',
  templateUrl: './toilet-urinal.component.html',
  styleUrls: ['./toilet-urinal.component.scss']
})
export class ToiletUrinalComponent implements OnInit {
  ...
  tabLabel:any='Toilet & Urinal';
  @ViewChild('udiseschoolinframap') udiseSchoolinfraMap:UdiseSchoolinfraToiletMapComponent ;
