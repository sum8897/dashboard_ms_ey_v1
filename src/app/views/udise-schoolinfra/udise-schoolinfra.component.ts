...
@Component({
  selector: 'app-udise-schoolinfra',
  templateUrl: './udise-schoolinfra.component.html',
  styleUrls: ['./udise-schoolinfra.component.scss']
})
export class UdiseSchoolinfraComponent implements OnInit {
