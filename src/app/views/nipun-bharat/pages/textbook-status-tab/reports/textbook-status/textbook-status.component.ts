...
@Component({
  selector: 'app-textbook-status',
  templateUrl: './textbook-status.component.html',
  styleUrls: ['./textbook-status.component.scss']
})
export class TextbookStatusComponent implements OnInit {

  reportName: string = 'textbook_status';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "TextBook Status"
  };
  title: string = 'TextBook Status'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
