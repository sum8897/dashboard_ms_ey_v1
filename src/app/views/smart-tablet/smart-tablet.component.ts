...
import { config } from './config/smart_tablet_config';
@Component({
  selector: 'app-smart-tablet',
  templateUrl: './smart-tablet.component.html',
  styleUrls: ['./smart-tablet.component.scss']
})
export class SmartTabletComponent implements OnInit {
  loadTabs = false;
  tabIndex;
  rbacDetails: any;
  selectedTabLabel;
  tabs: any = [];
  programName : any = 'smartTablet'
