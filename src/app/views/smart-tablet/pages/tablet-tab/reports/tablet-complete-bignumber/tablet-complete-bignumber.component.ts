...
@Component({
  selector: 'app-tablet-complete-bignumber',
  templateUrl: './tablet-complete-bignumber.component.html',
  styleUrls: ['./tablet-complete-bignumber.component.scss']
})
export class TabletCompleteBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'tablet_complete_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
