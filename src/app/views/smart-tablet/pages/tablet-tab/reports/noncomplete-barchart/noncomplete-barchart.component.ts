...
import { DataService } from 'src/app/core/services/data.service';import { TabletTabComponent } from 'src/app/views/smart-tablet/pages/tablet-tab/tablet-tab.component';
import { config } from 'src/app/views/smart-tablet/config/smart_tablet_config';
@Component({
  selector: 'app-noncomplete-barchart',
  templateUrl: './noncomplete-barchart.component.html',
  styleUrls: ['./noncomplete-barchart.component.scss']
})
export class NoncompleteBarchartComponent implements OnInit, OnDestroy {
  ...
  data;
  fileName: string = "";
  reportName: string = 'noncomplete_barchart';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
