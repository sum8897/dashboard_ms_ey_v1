...
import { TabletTabComponent } from 'src/app/views/smart-tablet/pages/tablet-tab/tablet-tab.component';
import { config } from 'src/app/views/smart-tablet/config/smart_tablet_config';

@Component({
  selector: 'app-tablet-noncomplete-bignumber',
  templateUrl: './tablet-noncomplete-bignumber.component.html',
  styleUrls: ['./tablet-noncomplete-bignumber.component.scss']
})
export class TabletNoncompleteBignumberComponent implements OnInit, OnDestroy {

  reportName: string = 'tablet_noncomplete_bignumber';
  filters: any = [];
  levels: any;
  tableReportData: any;
  bigNumberReportData: any = {
    reportName: "Sum of Non Active Devices"
  };
  ...
  constructor(private readonly _commonService: CommonService,
    private csv: TabletTabComponent, 
