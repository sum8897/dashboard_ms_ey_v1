...
@Component({
  ...
  styleUrls: ['./tablet-table.component.scss']
})
export class TabletTableComponent implements OnInit, OnDestroy {
  reportName: string = 'tablet_table';
  filters: any = [];
  levels: any;
  tableReportData: any;
  backUpData: any = [];
