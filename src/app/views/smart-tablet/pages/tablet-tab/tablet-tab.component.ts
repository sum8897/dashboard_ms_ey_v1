...
import { config } from 'src/app/views/smart-tablet/config/smart_tablet_config';
import { TabletTableComponent } from 'src/app/views/smart-tablet/pages/tablet-tab/reports/tablet-table/tablet-table.component';
...
@Component({
  selector: 'app-tablet-tab',
  templateUrl: './tablet-tab.component.html',
  styleUrls: ['./tablet-tab.component.scss']
})
export class TabletTabComponent implements OnInit, OnDestroy {
...
hasCommonFilters: boolean = true;
  ...
  async ngAfterViewInit(): Promise<void> {
      if (this.hasCommonFilters) {
          ...
          this.tabletTable?.getReportData({filterneed: this.hasCommonFilters, filterValues: this.filters.map((filter) => { return { ...filter, columnName: filter.valueProp, filterType: filter.id } }) },this.startDate,this.endDate);
